...
public partial class ScalarMultiplyAndSliceModel
{
    public static Tensor<float32> Inline(Tensor<float32> input)
    {
        ...
        return (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(scaled, Vector(1L), Vector(5L));
    }
}
...
public partial class ScalarMultiplyAndTileModel
{
    public static Tensor<float32> Inline(Tensor<float32> input)
    {
        var weight = InitScalarWeight.Init(Vector(1L));
        var scaled = input * weight;
        return (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Tile(scaled, Vector(2L));
    }
}
...
public partial class ScalarMultiplyAndClipModel
{
    public static Tensor<float32> Inline(Tensor<float32> input)
    {
        var weight = InitScalarWeight.Init(Vector(1L));
        var scaled = input * weight;
        return (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Clip((ITensor)scaled, (IScalar)Scalar(-1f), (IScalar)Scalar(1f));
    }
}
...
public partial class ScalarMultiplyAndExpandNoOpModel
{
    public static Tensor<float32> Inline(Tensor<float32> input)
    {
        var weight = InitScalarWeight.Init(Vector(1L));
        var scaled = input * weight;
        return (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Expand(scaled, Vector(8L));
    }
}
...
public partial class ScalarMultiplyAndScatterModel
{
    public static Tensor<float32> Inline(Tensor<float32> input)
    {
        var weight = InitScalarWeight.Init(Vector(1L));
        var scaled = input * weight;
        var updates = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(scaled, Vector(0L), Vector(1L));
        var indices = Vector(1L);
        return (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.ScatterElements(
...
public partial class ScalarMultiplyWithOrtOnlyLoopIterCountModel
{
    public static Tensor<float32> Inline(Tensor<float32> input)
    {
        ...
        var det = (Scalar<float32>)(ImmutableScalar<float32>)OnnxOp.Det(identity);
...
public partial class BatchedMatmulModel
{
    public static Tensor<float32> Inline(Tensor<float32> input)
    {
        ...
        var attn = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Softmax(scores, axis: 2);
        var ctx = attn.MatMul(q);                                     // (B,S,S)@(B,S,E) -> (B,S,E) batched
        var pooled = ctx.Reduce(ReduceKind.Mean, Vector(1L), keepDims: false); // (B,E)
        return (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Softmax(pooled.MatMul(InitXavier.Init([embed, classes])), axis: 1);
    }
}
...
public class TrainingRigCoverageTests
{
    ...
    public void TestTrainingGraphBuilderFuncOverloadCoverage()
    {
        ...
        Func<Tensor<float32>, Tensor<float32>, Scalar<float32>> notAModule =
            (pred, targ) => ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.ReduceSum((ITensor)(pred - targ), keepdims: false)).Scalar();
