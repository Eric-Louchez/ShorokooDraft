...
public class CSharpModelBuilderCoverageTests
{
    ...
    {
        var unrankedScalarInit = (Scalar<float32>)(ImmutableScalar<float32>)OnnxOp.Identity(Scalar(1.0f), rank: null);
    ...
    public void TestSequenceElementRankInferenceDeepChain()
    {
        ...
        var unrankedElem = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Identity(
