...
public class CSharpModelBuilderCoverageTests
{
    ...
    {
        var unrankedScalarInit = (Scalar<float32>)(ImmutableScalar)OnnxOp.Identity(Scalar(1.0f), rank: null);
    ...
    public void TestSequenceElementRankInferenceDeepChain()
    {
        ...
        var unrankedElem = (Tensor<float32>)(ImmutableTensor)OnnxOp.Identity(
