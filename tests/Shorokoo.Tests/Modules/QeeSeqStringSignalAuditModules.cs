namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeSequenceCoreAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x, Scalar<int64> p0)
        {
            ...
            var seq = (TensorSequence<float32>)(Variable)OnnxOp.SequenceConstruct(t1, t2);
            var at0 = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq, p0);
            var atNeg = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq, p0 - Scalar(1L)); // −1 → t2

            var ins = (TensorSequence<float32>)(Variable)OnnxOp.SequenceInsert(seq, t3, p1); // [t1,t3,t2]
            var insAt = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(ins, p1);

            var er = (TensorSequence<float32>)(Variable)OnnxOp.SequenceErase(seq, p0);       // [t2]
            var erAt = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(er, p0);
            var erLast = (TensorSequence<float32>)(Variable)OnnxOp.SequenceErase(ins);       // [t1,t3]
            var erLastAt = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(erLast, p1);
    ...
    public partial class QeeSplitToSeqConcatAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x, Scalar<int64> p0)
        {
            ...
            var stsDef = (TensorSequence<float32>)(Variable)OnnxOp.SplitToSequence(x);
            var defAt0 = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(stsDef, p0);

            var stsNk = (TensorSequence<float32>)(Variable)OnnxOp.SplitToSequence(x, split: null, axis: 0L, keepdims: 0L);
            var nkAt1 = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(stsNk, p1);

            // Scalar split 2 along axis 1 → [2,2] + [2,1].
            var stsS = (TensorSequence<float32>)(Variable)OnnxOp.SplitToSequence(x, split: Scalar(2L), axis: 1L);
            var sAt1 = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(stsS, p1);

            var stsV = (TensorSequence<float32>)(Variable)OnnxOp.SplitToSequence(x, split: Vector(1L, 2L), axis: 1L);
            var vAt1 = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(stsV, p1);
    ...
    public partial class QeeSplitKeepdimsInteractionAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x, Scalar<int64> p0)
        {
            var sts = (TensorSequence<float32>)(Variable)OnnxOp.SplitToSequence(x, split: Scalar(2L), axis: 1L, keepdims: 0L);
            var last = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(sts, p0 + Scalar(1L));
            var mismatch =
    ...
    public partial class QeeReverseSequenceAuditCheck
    {
        ...
        {
            var revBatch = (Tensor<float32>)(Variable)OnnxOp.ReverseSequence(
                x4, Vector(1L, 2L, 3L, 4L), batchAxis: 0, timeAxis: 1);
            // No attrs → spec defaults batch_axis=1, time_axis=0.
            var revTime = (Tensor<float32>)(Variable)OnnxOp.ReverseSequence(x4, Vector(4L, 3L, 2L, 1L));
    ...
    public partial class QeeOptionalAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var has = ((Scalar<bit>)(Variable)OnnxOp.OptionalHasElement(opt)).Cast<int64>();
            var got = (Tensor<float32>)(Variable)OnnxOp.OptionalGetElement(opt);

            var optNone = OnnxOp.Optional(null, DataStructure.Tensor, DType.Float32);
            var hasNone = ((Scalar<bit>)(Variable)OnnxOp.OptionalHasElement(optNone)).Cast<int64>();
    ...
    public partial class QeeWindowValueAuditCheck
    {
        public static Scalar<bit> Inline(Scalar<int64> size)
        {
            ...
            var hann8 = (Tensor<float32>)(Variable)OnnxOp.HannWindow(size, outputDatatype: DType.Float32);
            var hannSym5 = (Tensor<float32>)(Variable)OnnxOp.HannWindow(n5, outputDatatype: DType.Float32, periodic: false);
            var hamm4 = (Tensor<float32>)(Variable)OnnxOp.HammingWindow(n4, outputDatatype: DType.Float32);
            var hammSym5 = (Tensor<float32>)(Variable)OnnxOp.HammingWindow(n5, outputDatatype: DType.Float32, periodic: false);
            var black4 = (Tensor<float32>)(Variable)OnnxOp.BlackmanWindow(n4, outputDatatype: DType.Float32, periodic: true);
            var blackSym5 = (Tensor<float32>)(Variable)OnnxOp.BlackmanWindow(n5, outputDatatype: DType.Float32, periodic: false);
    ...
    public partial class QeeDftStftMelAuditCheck
    {
        ...
        {
            var dftF = (Tensor<float32>)(Variable)OnnxOp.Dft(sig, null, null, inverse: false, onesided: false);
            var dftOne = (Tensor<float32>)(Variable)OnnxOp.Dft(sig, null, null, inverse: false, onesided: true);
            var dftInv = (Tensor<float32>)(Variable)OnnxOp.Dft(dftF, null, null, inverse: true, onesided: false);
            var dftLen = (Tensor<float32>)(Variable)OnnxOp.Dft(sig, Scalar(2L), Scalar(1L), inverse: false, onesided: false);

            var stft = (Tensor<float32>)(Variable)OnnxOp.STFT(stftSig, frameStep, window: win, frameLength: null, onesided: true);
            var mel = (Tensor<float32>)(Variable)OnnxOp.MelWeightMatrix(
    ...
    public partial class QeeTfIdfShapeAuditCheck
    {
        ...
        {
            var v1 = (Tensor<float32>)(Variable)OnnxOp.TfIdfVectorizer(xi,
            ...
            var v2 = (Tensor<float32>)(Variable)OnnxOp.TfIdfVectorizer(xi.Reshape(Vector(1L, 4L)),
                maxGramLength: 2L, maxSkipCount: 0L, minGramLength: 1L, mode: "TF",
                ngramCounts: new long[] { 0L, 2L },
                ngramIndexes: new long[] { 2L, 0L, 4L },
                poolInt64s: new long[] { 1L, 2L, 3L, 4L },
    ...
    public partial class QeeStringOpsAuditCheck
    {
        ...
        {
            var concat = (Tensor<@string>)(Variable)OnnxOp.StringConcat(x, y);
            var norm = (Tensor<@string>)(Variable)OnnxOp.StringNormalizer(x, caseChangeAction: "LOWER");
            var normStop = (Tensor<@string>)(Variable)OnnxOp.StringNormalizer(x,
                caseChangeAction: "LOWER", isCaseSensitive: 0L, locale: "en_US",
                stopwords: new[] { "the" });
            var regex = (Tensor<bit>)(Variable)OnnxOp.RegexFullMatch(concat, pattern: ".*");
            ...
            var mismatch =
                ...
                ShapeMismatch((Tensor<int64>)(Variable)numSplits, Vector(2L));
            return (mismatch < Scalar(1L), normStop, (Tensor<@string>)(Variable)splitY);
        }
    ...
    public partial class QeeInternalControlFlowAuditCheck
    {
            ...
            Tensor<float32> x, Tensor<float32> xImg, Tensor<float32> w, Vector<float32> b)
        {
            ...
            var link = (Tensor<float32>)(Variable)InternalOp.StateUpdateLink(x, updated);
            var main = (Tensor<float32>)(Variable)InternalOp.WithStateDeps(x, link);

            var conv = (Tensor<float32>)(Variable)InternalOp.Conv(xImg, w, b, AutoPad.NotSet,
            ...
            var srn = (Tensor<float32>)(Variable)InternalOp.RandomNormal(x.ShapeTensor(), mean: 0f, scale: 1f, seed: 7f);
            var sru = (Tensor<float32>)(Variable)InternalOp.RandomUniform(x.ShapeTensor(), high: 1f, low: 0f, seed: 8f);

            var loopIdx = (Tensor<int64>)(Variable)OnnxOp.LoopIndexVariable();
            var fakeInput = (Tensor<float32>)(Variable)OnnxOp.LoopFakeInput(DType.Float32, rank: 2, DataStructure.Tensor);
            var scanVar = (Tensor<float32>)(Variable)OnnxOp.LoopScanZombie(x);
