namespace Shorokoo.Tests.Modules
{
    ...
    public partial class AutoGradBitwiseStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var via = (Tensor<int64>)(ImmutableTensor<int64>)OnnxOp.BitwiseAnd(asInt, Vector(0xFL));
            var via2 = (Tensor<int64>)(ImmutableTensor<int64>)OnnxOp.BitwiseOr(via, Vector(0L));
            var via3 = (Tensor<int64>)(ImmutableTensor<int64>)OnnxOp.BitwiseXor(via2, Vector(0L));
    ...
    public partial class AutoGradBooleanStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var bAnd = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.And(asBit, asBit);
            var bOr = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Or(bAnd, asBit);
            var bXor = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Xor(bOr, (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Expand(Scalar(false), x.DShape));
            var bNot = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Not(bXor);
    ...
    public partial class AutoGradComparisonStubCheck
    {
        ...
        {
            var eq = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Equal(x, y);
            var gt = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Greater(x, y);
            var ge = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.GreaterOrEqual(x, y);
            var lt = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Less(x, y);
            var le = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.LessOrEqual(x, y);
            var combined = (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Or(eq,
                (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Or(gt,
                    (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Or(ge,
                        (Tensor<bit>)(ImmutableTensor<bit>)OnnxOp.Or(lt, le))));
    ...
    public partial class AutoGradRangeStubCheck
    {
        ...
        {
            var rng = (Vector<int64>)(ImmutableVector<int64>)OnnxOp.Range(x.Cast<int64>(), Scalar(5L), Scalar(1L));
    ...
    public partial class AutoGradQuantizeLinearStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var scaleVec = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Expand(Scalar(0.5f), Vector(1L));
            var q = NN.QuantizeLinear<float32, uint8>(x, scaleVec);
            var dq = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.DequantizeLinear(
    ...
    public partial class AutoGradDynamicQuantizeLinearStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var y = (Tensor<uint8>)(ImmutableTensor<uint8>)OnnxOp.DynamicQuantizeLinear(x).y;
...
/// <summary>HammingWindow and HannWindow built from a length scalar (non-diff). The
    ...
    public partial class AutoGradWindowsStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var ham = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.HammingWindow(Scalar(4L), outputDatatype: DType.Float32, periodic: true);
            var han = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.HannWindow(Scalar(4L), outputDatatype: DType.Float32, periodic: true);
    ...
    public partial class AutoGradNonMaxSuppressionStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var boxes = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Reshape(
                (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Concat([x, x, x, x], axis: 0),
                Vector(1L, -1L, 4L), allowZero: false);
            var scores = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Reshape(x, Vector(1L, 1L, -1L), allowZero: false);
    ...
    public partial class AutoGradSTFTStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var signal = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Reshape(x, Vector(1L, -1L, 1L), allowZero: false);
            var spec = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.STFT(signal, Scalar(2L), window: null,
    ...
    public partial class AutoGradDeformConvStubCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var input4d = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Reshape(x, Vector(1L, 1L, 4L, 4L), allowZero: false);
            var w = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Expand(Scalar(1f), Vector(1L, 1L, 3L, 3L));
            var offset = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Expand(Scalar(0f), Vector(1L, 18L, 2L, 2L));
            var dc = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.DeformConv(input4d, w, offset, b: null, mask: null,
