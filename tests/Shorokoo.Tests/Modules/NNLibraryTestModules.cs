...
public partial class NNEmbeddingMaxNormClampsL2
{
    public static Scalar<bit> Inline(Tensor<int64> indices)
    {
        ...
        var yOverRow = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(y, Vector(0L), Vector(1L), Vector(0L)); // [1,4]
...
public partial class NNCrossEntropyReductionWeightIgnoreChecks
{
    public static Scalar<bit> Inline(Tensor<float32> t)
    {
        ...
        var cePer0 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(cePer, Vector(0L), Vector(1L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        var cePer1 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(cePer, Vector(1L), Vector(2L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        ...
        var ceIgPer1 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(ceIgPer, Vector(1L), Vector(2L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
...
public partial class NNNLLLossWeightIgnoreChecks
{
    public static Scalar<bit> Inline(Tensor<float32> t)
    {
        ...
        var igPer1 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(igPer, Vector(1L), Vector(2L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
...
public partial class NNRegressionReductionChecks
{
    public static Scalar<bit> Inline(Tensor<float32> t)
    {
        ...
        var l1Per0 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(l1Per, Vector(0L), Vector(1L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        var l1Per1 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(l1Per, Vector(1L), Vector(2L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
...
public partial class AnalyticSliceParamModel
{
    ...
    {
        var w = AnalyticInitRange4.Init(Vector(4L));
        return (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(w, Vector(0L), Vector(2L)) * x;
    }
}
...
public partial class NNLossEdgeCaseChecks
{
    public static Scalar<bit> Inline(Tensor<float32> d)   // d = [0.5, 2]
    {
        ...
        var quad = SmoothL1Loss.Inline((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(d, Vector(0L), Vector(1L)), z1);
        var lin = SmoothL1Loss.Inline((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(d, Vector(1L), Vector(2L)), z1);
...
public partial class NNLogCoshLossChecks
{
    public static Scalar<bit> Inline(Tensor<float32> t)
    {
        ...
        var per0 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(per, Vector(0L), Vector(1L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        var per1 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(per, Vector(1L), Vector(2L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
...
public partial class NNPoissonNLLLossChecks
{
    public static Scalar<bit> Inline(Tensor<float32> t)
    {
        ...
        var full0 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(perFull, Vector(0L), Vector(1L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        var full1 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(perFull, Vector(1L), Vector(2L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        var full2 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(perFull, Vector(2L), Vector(3L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
...
public partial class NNHingeLossChecks
{
    public static Scalar<bit> Inline(Tensor<float32> t)
    {
        ...
        var per0 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(per, Vector(0L), Vector(1L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        var per1 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(per, Vector(1L), Vector(2L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        var per2 = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(per, Vector(2L), Vector(3L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
...
public partial class RnnCellForwardTanhGradCheck
{
    public static Scalar<bit> Inline(Scalar<float32> v)
    {
        Func<Scalar<float32>, Scalar<float32>> f = z =>
        {
            ...
            var zv = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Unsqueeze(z, Vector(0L));
            var x = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Concat([zv, Vector(0.4f)], axis: 0)).Reshape([Scalar(1L), Scalar(2L)]);
            var h = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Concat([zv, Vector(-0.2f)], axis: 0)).Reshape([Scalar(1L), Scalar(2L)]);
...
public partial class RnnCellReluBpttThrowCheck
{
    public static Scalar<bit> Inline(Scalar<float32> v)
    {
        var zv = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Unsqueeze(v, Vector(0L));
        var x = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Concat([zv, Vector(0.4f)], axis: 0)).Reshape([Scalar(1L), Scalar(2L)]);
...
public partial class LstmCellForwardGradCheck
{
    public static Scalar<bit> Inline(Scalar<float32> v)
    {
        Func<Scalar<float32>, Scalar<float32>> f = z =>
        {
            ...
            var x = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Concat([zv, Vector(0.4f)], axis: 0)).Reshape([Scalar(1L), Scalar(2L)]);
            var h = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Concat([zv, Vector(-0.2f)], axis: 0)).Reshape([Scalar(1L), Scalar(2L)]);
            var c = ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Concat([zv, Vector(0.1f)], axis: 0)).Reshape([Scalar(1L), Scalar(2L)]);
...
public partial class NNTripletEmbeddingRigModel
{
    public static Scalar<float32> Inline(Tensor<float32> apn)   // [3N, D] = [6, 2]
    {
        ...
        var ea = embed.Call((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(apn, Vector(0L), Vector(2L)));   // anchor   [2,2]
        var ep = embed.Call((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(apn, Vector(2L), Vector(4L)));   // positive [2,2]
        var en = embed.Call((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(apn, Vector(4L), Vector(6L)));   // negative [2,2]
...
public partial class NNCosineEmbeddingClosedFormChecks
{
    ...
    private static Scalar<float32> Slice1(Tensor<float32> v, long i)
        => ((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(v, Vector(i), Vector(i + 1L))).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
...
public partial class NNCosineEmbeddingRigModel
{
    ...
    {
        var embed = Linear.Model(Scalar(2L), Scalar(true));     // shared trainable embedding [D]→[2]
        var e1 = embed.Call((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(pair, Vector(0L), Vector(2L)));   // x1 [2,2]
        var e2 = embed.Call((Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(pair, Vector(2L), Vector(4L)));   // x2 [2,2]
