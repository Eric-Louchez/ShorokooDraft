namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeAveragePoolShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var dil = (Tensor<float32>)(ImmutableTensor)OnnxOp.AveragePool(x, autoPad: AutoPad.NotSet, ceilMode: false,
            ...
            var ceilClamp = (Tensor<float32>)(ImmutableTensor)OnnxOp.AveragePool(x, autoPad: AutoPad.NotSet, ceilMode: true,
                countIncludePad: true, dilations: [1L, 1L], kernelShape: [2L, 2L],
                pads: [1L, 1L, 1L, 1L], strides: [4L, 4L]);
            // SAME_UPPER: ceil(10/3) = 4.
            var sameUpper = (Tensor<float32>)(ImmutableTensor)OnnxOp.AveragePool(x, autoPad: AutoPad.SameUpper, ceilMode: false,
                countIncludePad: false, dilations: null, kernelShape: [4L, 4L],
                pads: null, strides: [3L, 3L]);
            // VALID: (10-4)/2+1 = 4.
            var valid = (Tensor<float32>)(ImmutableTensor)OnnxOp.AveragePool(x, autoPad: AutoPad.Valid, ceilMode: false,
                countIncludePad: false, dilations: null, kernelShape: [4L, 4L],
    ...
    public partial class QeeLpPoolGlobalPoolShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var lpCeilClamp = (Tensor<float32>)(ImmutableTensor)OnnxOp.LpPool(x, autoPad: AutoPad.NotSet, ceilMode: true,
                dilations: [1L, 1L], kernelShape: [2L, 2L], p: 3L,
                pads: [1L, 1L, 1L, 1L], strides: [4L, 4L]);
            // dilations: (10 - ((3-1)*2+1))/2 + 1 = 3.
            var lpDil = (Tensor<float32>)(ImmutableTensor)OnnxOp.LpPool(x, autoPad: AutoPad.NotSet, ceilMode: false,
    ...
    public partial class QeeQuantizedConvShapeAuditCheck
    {
            ...
            Scalar<float32> xScale, Scalar<float32> wScale, Scalar<float32> yScale, Scalar<int8> yZp)
        {
            ...
            var ciDil = (Tensor<int32>)(ImmutableTensor)OnnxOp.ConvInteger(x, w, xZp, wZp,
            ...
            var ciSame = (Tensor<int32>)(ImmutableTensor)OnnxOp.ConvInteger(x, w, xZp, wZp,
            ...
            var qlcSame = (Tensor<int8>)(ImmutableTensor)OnnxOp.QLinearConv(x, xScale, xZp, w, wScale, wZp, yScale, yZp,
                b: null, autoPad: AutoPad.SameUpper, dilations: null, group: 1L,
                kernelShape: [3L, 3L], pads: null, strides: [2L, 2L]);
            // QLinearConv asymmetric pads [2,0,0,1]: H 7+2+0-3+1 = 7, W 7+0+1-3+1 = 6.
            var qlcAsym = (Tensor<int8>)(ImmutableTensor)OnnxOp.QLinearConv(x, xScale, xZp, w, wScale, wZp, yScale, yZp,
    ...
    public partial class QeeMaxRoiPoolShapeAuditCheck
    {
        ...
        {
            var roi = (Tensor<float32>)(ImmutableTensor)OnnxOp.MaxRoiPool(x, rois,
    ...
    public partial class QeeDeformConvShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x, Tensor<float32> w, Tensor<float32> offset, Vector<float32> b)
        {
            ...
            var dc = (Tensor<float32>)(ImmutableTensor)OnnxOp.DeformConv(x, w, offset, b, mask: null,
    ...
    public partial class QeeMaxUnpoolShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> pooled, Tensor<int64> indices)
        {
            ...
            var formula = (Tensor<float32>)(ImmutableTensor)OnnxOp.MaxUnpool(pooled, indices,
                kernelShape: [2L, 2L], pads: [1L, 0L, 1L, 0L], strides: [2L, 2L]);
            // output_shape input overrides the formula (default would be [1,1,4,4]).
            var overridden = (Tensor<float32>)(ImmutableTensor)OnnxOp.MaxUnpool(pooled, indices,
