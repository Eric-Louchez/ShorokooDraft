namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeResizeShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var scalesAll = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
            ...
            var sizesAll = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
            ...
            var axesSizes = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
            ...
            var axesScales = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
            ...
            var notLarger = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
            ...
            var notSmaller = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
                scales: null, sizes: Vector(4L, 6L),
                antialias: null, axes: [2L, 3L], coordinateTransformationMode: null,
                cubicCoeffA: null, excludeOutside: null, extrapolationValue: null,
            ...
            var cubic = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
            ...
            var anti = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
            ...
            var cropResize = (Tensor<float32>)(Variable)OnnxOp.Resize(x,
    ...
    public partial class QeeResizeNegativeAxesAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var negScales = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
                scales: Vector(0.5f), sizes: null,
                antialias: null, axes: [-1L], coordinateTransformationMode: null,
                cubicCoeffA: null, excludeOutside: null, extrapolationValue: null,
                keepAspectRatioPolicy: null, mode: ResizeMode.Nearest, nearestMode: null);
            // axes [-2, -1] = dims 2, 3 with sizes.
            var negSizes = (Tensor<float32>)(Variable)OnnxOp.Resize(x, roi: null,
    ...
    public partial class QeeUpsampleAffineGridSampleAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var up = (Tensor<float32>)(Variable)OnnxOp.Upsample(x, Vector(1f, 2f, 1.5f, 2f),
            ...
            var theta = OnnxOp.Reshape(Vector(1f, 0f, 0f, 0f, 1f, 0f), Vector(1L, 2L, 3L),
                allowZero: false);
            var grid = (Tensor<float32>)(Variable)OnnxOp.AffineGrid(theta, Vector(1L, 2L, 3L, 5L),
                alignCorners: false);
            // GridSample: batch/channels from X, spatial dims from the grid → [1,2,3,5].
            var sampledLinear = (Tensor<float32>)(Variable)OnnxOp.GridSample(x, grid,
                alignCorners: false, mode: GridSampleMode.Linear,
                paddingMode: GridSamplePaddingMode.Zeros);
            var sampledNearest = (Tensor<float32>)(Variable)OnnxOp.GridSample(x, grid,
    ...
    public partial class QeeAffineGridSample5DAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x5)
        {
            ...
            var grid5 = (Tensor<float32>)(Variable)OnnxOp.AffineGrid(theta3d, Vector(1L, 1L, 2L, 3L, 4L),
                alignCorners: true);
            var sampled5 = (Tensor<float32>)(Variable)OnnxOp.GridSample(x5, grid5,
    ...
    public partial class QeeRoiAlignShapeAuditCheck
    {
        ...
        {
            var avg = (Tensor<float32>)(Variable)OnnxOp.RoiAlign(x, rois, batchIdx,
            ...
            var max = (Tensor<float32>)(Variable)OnnxOp.RoiAlign(x, rois, batchIdx,
    ...
    public partial class QeeNmsOrtShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> boxes, Tensor<float32> scores)
        {
            ...
            var nms2 = (Tensor<int64>)(Variable)OnnxOp.NonMaxSuppression(boxes, scores,
                Scalar(2L), Scalar(0.5f), Scalar(0.0f), centerPointBox: false);
            // Cap of one box per class → [1,3].
            var nms1 = (Tensor<int64>)(Variable)OnnxOp.NonMaxSuppression(boxes, scores,
                Scalar(1L), Scalar(0.5f), Scalar(0.0f), centerPointBox: false);
            // center_point_box=1 ([cx,cy,w,h] interpretation), cap 1 → [1,3].
            var nmsCenter = (Tensor<int64>)(Variable)OnnxOp.NonMaxSuppression(boxes, scores,
    ...
    public partial class QeeNmsEmptyAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> boxes, Tensor<float32> scores)
        {
            var nmsEmpty = (Tensor<int64>)(Variable)OnnxOp.NonMaxSuppression(boxes, scores);
    ...
    public partial class QeeNmsRankOnlyCheck
    {
        public static Tensor<int64> Inline(Tensor<float32> boxes, Tensor<float32> scores)
            => (Tensor<int64>)(Variable)OnnxOp.NonMaxSuppression(boxes, scores,
                Scalar(2L), Scalar(0.5f), Scalar(0.0f), centerPointBox: false);
    }
    ...
    public partial class QeeCol2ImCenterCropPadAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> cols, Tensor<float32> img)
        {
            ...
            var c2i = (Tensor<float32>)(Variable)OnnxOp.Col2Im(cols, Vector(4L, 5L), Vector(2L, 2L),
            ...
            var cropPad = (Tensor<float32>)(Variable)OnnxOp.CenterCropPad(img, Vector(2L, 7L), axes: null);
            // Negative axis subset: axes [-1], cols crop 5→4 (offset 0 → cols 0..3) → Σ = 90.
            var cropAxes = (Tensor<float32>)(Variable)OnnxOp.CenterCropPad(img, Vector(4L), axes: [-1L]);
            // Pad rows 3→5: begin pad (5-3)/2 = 1 → out row 0 is zeros, out row 1 = in row 0.
            var padRows = (Tensor<float32>)(Variable)OnnxOp.CenterCropPad(img, Vector(5L, 5L), axes: null);
            var padRow0 = (Tensor<float32>)(Variable)OnnxOp.Gather(padRows, Scalar(0L), axis: 0);
            var padRow1 = (Tensor<float32>)(Variable)OnnxOp.Gather(padRows, Scalar(1L), axis: 0);
    ...
    public partial class QeeRandomFamilyAuditCheck
    {
        ...
        {
            var rn = (Tensor<float32>)(Variable)OnnxOp.RandomNormal([2L, 2L], mean: 0f, scale: 1f,
                dtype: DType.Float32, seed: 5f);
            // dtype omitted → defaults to float32 (validated by the QEE dtype pass).
            var ru = (Tensor<float32>)(Variable)OnnxOp.RandomUniform([3L], high: 1f, low: 0f,
                dtype: null, seed: 3f);
            var rnl = (Tensor<float32>)(Variable)OnnxOp.RandomNormalLike(probs, mean: 0f, scale: 1f,
                dtype: null, seed: 1f);
            // dtype override on the Like-variant.
            var rul = (Tensor<float64>)(Variable)OnnxOp.RandomUniformLike(probs, high: 1f, low: 0f,
                dtype: DType.Float64, seed: 2f);
            var bern = (Tensor<float32>)(Variable)OnnxOp.Bernoulli(probs, dtype: null, seed: 7f);
            var bernInt = (Tensor<int32>)(Variable)OnnxOp.Bernoulli(probs, dtype: DType.Int32, seed: 7f);
            // No dtype → int32 per spec (the node-def default branch used to be unresolvable).
            var mult = (Tensor<int32>)(Variable)OnnxOp.Multinomial(logits, dtype: null, sampleSize: 5L, seed: 11f);

            // EyeLike is deterministic: ones on diagonal k. [2,4] k=1 → 2 ones; k=-1 → 1 one.
            var eyeUp = (Tensor<float32>)(Variable)OnnxOp.EyeLike(logits, dtype: null, k: 1);
            var eyeDown = (Tensor<int64>)(Variable)OnnxOp.EyeLike(logits, dtype: DType.Int64, k: -1);
    ...
    public partial class QeeRandomSeededDeterminismCheck
    {
        ...
        {
            var rn1 = (Tensor<float32>)(Variable)OnnxOp.RandomNormal([2L, 3L], mean: 0f, scale: 1f,
                dtype: DType.Float32, seed: 42f);
            var rn2 = (Tensor<float32>)(Variable)OnnxOp.RandomNormal([2L, 3L], mean: 0f, scale: 1f,
                dtype: DType.Float32, seed: 42f);
            var ru1 = (Tensor<float32>)(Variable)OnnxOp.RandomUniform([2L, 3L], high: 1f, low: 0f,
                dtype: DType.Float32, seed: 7f);
            var ru2 = (Tensor<float32>)(Variable)OnnxOp.RandomUniform([2L, 3L], high: 1f, low: 0f,
                dtype: DType.Float32, seed: 7f);
    ...
    public partial class QeeRangeConstantOfShapeAuditCheck
    {
        public static Scalar<bit> Inline()
        {
            var rInt = (Tensor<int64>)(Variable)OnnxOp.Range(Scalar(0L), Scalar(7L), Scalar(2L));
            var rNeg = (Tensor<int64>)(Variable)OnnxOp.Range(Scalar(5L), Scalar(-5L), Scalar(-3L));
            var rEmpty = (Tensor<int64>)(Variable)OnnxOp.Range(Scalar(3L), Scalar(3L), Scalar(1L));
            var rFloat = (Tensor<float32>)(Variable)OnnxOp.Range(Scalar(0.5f), Scalar(2f), Scalar(0.5f));

            var cosInt = (Tensor<int64>)(Variable)OnnxOp.ConstantOfShape(Vector(2L, 3L),
                TensorData(DType.Int64, [1L], 5L));
            var cosBool = (Tensor<bit>)(Variable)OnnxOp.ConstantOfShape(Vector(2L, 2L),
    ...
    public partial class QeeConstantStringCheck
    {
        ...
        {
            var cs = (Tensor<@string>)(Variable)OnnxOp.Constant("hello");
            var css = (Tensor<@string>)(Variable)OnnxOp.Constant(new[] { "a", "b", "c" });
            return (cs, css);
        }
    }
    ...
    public partial class QeeRnnShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var mismatch =
                ShapeMismatch((Tensor<float32>)(Variable)y1, Vector(4L, 1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yh1, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)y3, Vector(4L, 2L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yh3, Vector(2L, 2L, 5L));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeGruShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var mismatch =
                ShapeMismatch((Tensor<float32>)(Variable)y1, Vector(4L, 1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yh1, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)y2, Vector(4L, 2L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yh2, Vector(2L, 2L, 5L));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeRecurrentQeeOnlyShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var xBatchFirst = (Tensor<float32>)(Variable)OnnxOp.Transpose(x, [1L, 0L, 2L]);
            ...
            var mismatch =
                ShapeMismatch((Tensor<float32>)(Variable)yRnn, Vector(4L, 1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yhRnn, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yGru, Vector(4L, 1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yhGru, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yLstm, Vector(4L, 1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yhLstm, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)ycLstm, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yRnnL, Vector(2L, 4L, 1L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yhRnnL, Vector(2L, 1L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yGruL, Vector(2L, 4L, 1L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yhGruL, Vector(2L, 1L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yLstmL, Vector(2L, 4L, 1L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yhLstmL, Vector(2L, 1L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)ycLstmL, Vector(2L, 1L, 5L));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeLstmShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x, Tensor<int32> seqLens)
        {
            ...
            var mismatch =
                ShapeMismatch((Tensor<float32>)(Variable)y1, Vector(4L, 1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yh1, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yc1, Vector(1L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)y2, Vector(4L, 2L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yh2, Vector(2L, 2L, 5L)) +
                ShapeMismatch((Tensor<float32>)(Variable)yc2, Vector(2L, 2L, 5L));
            return mismatch < Scalar(1L);
        }
