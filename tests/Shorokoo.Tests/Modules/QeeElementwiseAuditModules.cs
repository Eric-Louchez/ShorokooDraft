namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeActivationValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> xa, Tensor<float32> xg)
        {
            ...
            var mismatch =
                ...
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Gelu(xg), geluNoneExpected, tolerance: 1.5e-4f) +
                ...
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.PRelu(xa, Vector(0.25f)), Vector(-0.5f, -0.125f, 0f, 0.5f, 2f)) +
                ...
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Clip(xa, Scalar(-1f), Scalar(1f)), Vector(-1f, -0.5f, 0f, 0.5f, 1f));
            return mismatch < Scalar(1L);
        }

        // NaN-safe: Not(<= tol) counts a NaN diff as a mismatch; a plain "> tol" would pass it (IEEE).
        private static Scalar<int64> FloatMismatch(Tensor<float32> actual, Vector<float32> expected, float tolerance = 1e-3f)
            => ((Tensor<bit>)(Variable)OnnxOp.Not((actual - expected).Abs() <= Scalar(tolerance))).Cast<int64>()
                .Reduce(ReduceKind.Sum, keepDims: false).Scalar();
    }
    ...
    public partial class QeeBinaryArithValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> af, Tensor<float32> bf, Tensor<int64> ai, Tensor<int64> bi)
        {
            var mismatch =
                ...
                IntMismatch((Tensor<int64>)(Variable)OnnxOp.Mod(ai, bi), Vector(1L, 1L, -3L)) +
                // fmod=1 → C fmod (sign of dividend).
                IntMismatch((Tensor<int64>)(Variable)OnnxOp.Mod(ai, bi, fmod: true), Vector(1L, -1L, 1L)) +
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Mod(af, bf, fmod: true), Vector(1.5f, -2.5f, 1.25f)) +
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Min(af, bf, Scalar(0f)), Vector(0f, -5.5f, -4f)) +
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Max(af, bf, Scalar(0f)), Vector(7.5f, 3f, 9.25f)) +
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Sum(af, bf, Scalar(1f)), Vector(10.5f, -1.5f, 6.25f)) +
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Mean(af, bf, Scalar(1.5f)), Vector(3.666667f, -0.3333333f, 2.25f)) +
                IntMismatch((Tensor<int64>)(Variable)OnnxOp.Min(ai, bi), Vector(2L, -7L, -4L)) +
                IntMismatch((Tensor<int64>)(Variable)OnnxOp.Max(ai, bi), Vector(7L, 2L, 9L));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeCompareLogicValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> cf, Tensor<float32> cg, Tensor<bit> p, Tensor<bit> q)
        {
            ...
            var mismatch =
                ...
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.Equal(p, q), Vector(1L, 0L, 0L, 1L)) +
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.And(p, q), Vector(1L, 0L, 0L, 0L)) +
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.Or(p, q), Vector(1L, 1L, 1L, 0L)) +
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.Xor(p, q), Vector(0L, 1L, 1L, 0L)) +
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.Not(p), Vector(0L, 1L, 0L, 1L));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeBitwiseValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<int64> ba, Tensor<int64> bb)
        {
            ...
            var mismatch =
                IntMismatch(((Tensor<uint32>)(Variable)OnnxOp.BitwiseAnd(ua, ub)).Cast<int64>(), Vector(8L, 0L, 3L)) +
                IntMismatch(((Tensor<uint32>)(Variable)OnnxOp.BitwiseOr(ua, ub)).Cast<int64>(), Vector(14L, 15L, 15L)) +
                IntMismatch(((Tensor<uint32>)(Variable)OnnxOp.BitwiseXor(ua, ub)).Cast<int64>(), Vector(6L, 15L, 12L)) +
                IntMismatch(((Tensor<uint32>)(Variable)OnnxOp.BitwiseNot(ua)).Cast<int64>(),
                    Vector(4294967283L, 4294967285L, 4294967280L)) +
                IntMismatch(((Tensor<uint32>)(Variable)OnnxOp.BitShift(ua, ub, BitShiftDirection.Left)).Cast<int64>(),
                    Vector(12288L, 320L, 120L)) +
                IntMismatch(((Tensor<uint32>)(Variable)OnnxOp.BitShift(ua, ub, BitShiftDirection.Right)).Cast<int64>(),
                    Vector(0L, 0L, 1L));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeMiscElementwiseValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> wv, Tensor<float32> wd, Tensor<bit> pw)
        {
            ...
            var mismatch =
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.IsInf(q), Vector(1L, 1L, 0L, 0L)) +
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.IsInf(q, detectNegative: false, detectPositive: true), Vector(1L, 0L, 0L, 0L)) +
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.IsInf(q, detectNegative: true, detectPositive: false), Vector(0L, 1L, 0L, 0L)) +
                BoolMismatch((Tensor<bit>)(Variable)OnnxOp.IsNaN(q), Vector(0L, 0L, 1L, 0L)) +
                ...
                IntMismatch((Tensor<int64>)(Variable)OnnxOp.CastLike(scaled, castI, saturate: null), Vector(1L, -1L, 0L, 3L)) +
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Where(pw, wv, wd), Vector(1f, 0f, 0f, 1f)) +
                IntMismatch((Tensor<int64>)(Variable)OnnxOp.Where(pw, wv.Cast<int64>(), wd.Cast<int64>()), Vector(1L, 0L, 0L, 1L)) +
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.Expand(wv, Vector(2L, 4L)),
                    (Tensor<float32>)(Variable)OnnxOp.Reshape(Vector(1f, -1f, 0f, 2f, 1f, -1f, 0f, 2f), Vector(2L, 4L), allowZero: false));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeWhereBoolValueAuditCheck
    {
        ...
        {
            var whereB = (Tensor<bit>)(Variable)OnnxOp.Where(pw, pw, OnnxOp.Not(pw));
    ...
    public partial class QeeSliceReverseValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var reversed = (Tensor<float32>)(Variable)OnnxOp.Slice(x,
