namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeTopKUniqueValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var mismatch =
                ...
                FloatMismatch(Flat((Tensor<float32>)(ImmutableTensor)yS), Vector(1f, 2f, 3f, 4f)) +
                IntMismatch(FlatI((Tensor<int64>)(ImmutableTensor)idxS), Vector(1L, 0L, 3L, 4L)) +
                IntMismatch(FlatI((Tensor<int64>)(ImmutableTensor)invS), Vector(1L, 0L, 0L, 2L, 3L, 2L)) +
                IntMismatch(FlatI((Tensor<int64>)(ImmutableTensor)cntS), Vector(2L, 1L, 2L, 1L)) +
                FloatMismatch(Flat((Tensor<float32>)(ImmutableTensor)yF), Vector(2f, 1f, 3f, 4f)) +
                IntMismatch(FlatI((Tensor<int64>)(ImmutableTensor)idxF), Vector(0L, 1L, 3L, 4L)) +
                IntMismatch(FlatI((Tensor<int64>)(ImmutableTensor)invF), Vector(0L, 1L, 1L, 2L, 3L, 2L)) +
                IntMismatch(FlatI((Tensor<int64>)(ImmutableTensor)cntF), Vector(1L, 2L, 2L, 1L));
    ...
    public partial class QeeTopKUniqueShapeAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var mismatch =
                IntMismatch(((Tensor<float32>)(ImmutableTensor)y).ShapeTensor(), Vector(2L, 2L)) +
                IntMismatch(((Tensor<int64>)(ImmutableTensor)inv).ShapeTensor(), Vector(3L)) +
