namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeReshapeFamilyValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> r)
        {
            ...
            var tr3 = (Tensor<float32>)(Variable)OnnxOp.Transpose(r); // default perm = reverse dims
            ...
            var mismatch =
                ...
                ShapeMismatch((Tensor<float32>)(Variable)OnnxOp.Reshape(empty0, Vector(0L, 4L), allowZero: true), Vector(0L, 4L)) +
    ...
    public partial class QeeSliceGatherValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> g)
        {
            ...
            var mismatch =
                ...
                FloatMismatch(Flat((Tensor<float32>)(Variable)OnnxOp.GatherElements(
    ...
    public partial class QeeScatterPadValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> m)
        {
            ...
            var mismatch =
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.ScatterElements(v5, Vector(1L, 3L), Vector(10f, 20f)),
                ...
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.ScatterElements(v5, Vector(1L, 3L), Vector(0f, 20f),
                ...
                FloatMismatch((Tensor<float32>)(Variable)OnnxOp.ScatterElements(v5, Vector(-1L), Vector(99f)),
                    Vector(1f, 2f, 3f, 4f, 99f)) +
                FloatMismatch(Flat((Tensor<float32>)(Variable)OnnxOp.ScatterElements(d22,
    ...
    public partial class QeeSplitConcatTileSpaceValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> v7)
        {
            ...
            var s2d = (Tensor<float32>)(Variable)OnnxOp.SpaceToDepth(s, 2);
            var mismatch =
    ...
    public partial class QeeOneHotTriluNonZeroValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<int64> idx)
        {
            ...
            var mismatch =
                ...
                FloatMismatch(Flat((Tensor<float32>)(Variable)OnnxOp.Trilu(t9)),
                    Vector(1f, 2f, 3f, 0f, 5f, 6f, 0f, 0f, 9f)) +
                FloatMismatch(Flat((Tensor<float32>)(Variable)OnnxOp.Trilu(t9, Scalar(1L), 1L)),
                    Vector(0f, 2f, 3f, 0f, 0f, 6f, 0f, 0f, 0f)) +
                FloatMismatch(Flat((Tensor<float32>)(Variable)OnnxOp.Trilu(t9, null, 0L)),
                    Vector(1f, 0f, 0f, 4f, 5f, 0f, 7f, 8f, 9f)) +
                FloatMismatch(Flat((Tensor<float32>)(Variable)OnnxOp.Trilu(t9, Scalar(-1L), 0L)),
