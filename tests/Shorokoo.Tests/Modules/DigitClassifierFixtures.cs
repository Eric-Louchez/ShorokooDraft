...
public partial class SoftmaxL2Loss
{
    public static Scalar<float32> Inline(Tensor<float32> predictions, Tensor<float32> targets)
    {
        ...
        var perSample = (Tensor<float32>)(Variable)OnnxOp.ReduceSum((ITensor)squared, Vector(1L), keepdims: false, noopWithEmptyAxes: null);
        var batchMean = (Tensor<float32>)(Variable)OnnxOp.ReduceMean((ITensor)perSample, Vector(0L), keepdims: false);
