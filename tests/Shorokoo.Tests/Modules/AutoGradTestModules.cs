namespace Shorokoo.Tests.Modules
{
    ...
    public partial class AutoGradMatMulReduce
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var product = (Tensor<float32>)(Variable)OnnxOp.MatMul(x, w);
            var loss = product.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = (Tensor<float32>)(Variable)Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);

            // dL/dx[i,k] = sum_j W[k,j] — j-row-sum of W, broadcast over batch axis.
            var wRowSums = (Tensor<float32>)(Variable)OnnxOp.ReduceSum(w, axes: Vector(1L), keepdims: false, noopWithEmptyAxes: false);
    ...
    public partial class AutoGradTrainableParam
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var product = x * w;
            var loss = product.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = (Tensor<float32>)(Variable)Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(w, loss);
    ...
    public partial class AutoGradSliceWithAxes
    {
        ...
        {
            var sliced = (Tensor<float32>)(Variable)OnnxOp.Slice(
                x,
                starts: Vector(0L),
                ends: Vector(2L),
                axes: Vector(1L),
    ...
    public partial class AutoGradConvTranspose
    {
        ...
        {
            var convT = (Tensor<float32>)(Variable)NN.ConvTranspose(x, w, b, AutoPad.NotSet,
                dilations: [1L, 1L], group: 1L, kernelShape: [3L, 3L],
    ...
    public partial class AutoGradTransposePerm
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var transposed = (Tensor<float32>)(Variable)OnnxOp.Transpose(x, perm: [1L, 0L, 2L]);
    ...
    public partial class AutoGradPadAxes
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var padded = (Tensor<float32>)(Variable)OnnxOp.Pad(
                x,
                pads: Vector(1L, 1L),
    ...
    public partial class AutoGradTile
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var tiled = (Tensor<float32>)(Variable)OnnxOp.Tile(x, repeats: Vector(2L, 3L));
    ...
    public partial class AutoGradMaxPool
    {
        ...
        private static Scalar<float32> MaxPoolLoss(Tensor<float32> x)
        {
            ...
            var offsets = (Tensor<float32>)(Variable)OnnxOp.Reshape(
            ...
            var pooled = OnnxOp.MaxPool(
                ...
                storageOrder: 0L,
                strides: [2L, 2L]);
            return ((Tensor<float32>)(Variable)pooled).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        }
    }
    ...
    public partial class AutoGradAvgPool
    {
        ...
        {
            var pooled = (Tensor<float32>)(Variable)OnnxOp.AveragePool(
    ...
    public partial class AutoGradGemmTrans
    {
        public static Scalar<bit> Inline(Tensor<float32> a, Tensor<float32> b)
        {
            ...
            var grad = (Tensor<float32>)(Variable)Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
        ...
        {
            var gemm = (Tensor<float32>)(Variable)OnnxOp.Gemm(
    ...
    public partial class AutoGradPowCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x, Scalar<float32> y)
        {
            ...
            var expectedY = x.Pow(y) * ((Tensor<float32>)(Variable)OnnxOp.Log((Tensor<float32>)(Variable)x)).Scalar();
    ...
    public partial class AutoGradAbsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var loss = x.Abs();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            var expected = ((Tensor<float32>)(Variable)OnnxOp.Sign((Tensor<float32>)(Variable)x)).Scalar();
            return (grad - expected).Abs() < Scalar(1e-4f);
        }
    }
    ...
    public partial class AutoGradReciprocalCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reciprocal(x)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    public partial class AutoGradModSumCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Expand(b, Vector(2L));
            var modResult = (Tensor<float32>)(Variable)OnnxOp.Mod(aVec, bVec, fmod: true);
            var loss = modResult.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
            // trunc(a/b) = sign(a/b)·floor(|a/b|)
            var ratio = a / b;
            var trunc = ((Tensor<float32>)(Variable)OnnxOp.Sign((Tensor<float32>)(Variable)ratio)).Scalar()
                * ((Tensor<float32>)(Variable)OnnxOp.Floor((Tensor<float32>)(Variable)ratio.Abs())).Scalar();
    ...
    public partial class AutoGradAbsMulChainCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var loss = x.Abs() * x;
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            var sign = ((Tensor<float32>)(Variable)OnnxOp.Sign((Tensor<float32>)(Variable)x)).Scalar();
    ...
    public partial class AutoGradErfCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            Func<Scalar<float32>, Scalar<float32>> f = z => ((Tensor<float32>)(Variable)OnnxOp.Erf((Tensor<float32>)(Variable)z)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, f(x));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(x, grad, f);
        }
    }
    ...
    public partial class AutoGradErfMulChainCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            Func<Scalar<float32>, Scalar<float32>> f = z => ((Tensor<float32>)(Variable)OnnxOp.Erf((Tensor<float32>)(Variable)z)).Scalar() * z;
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, f(x));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(x, grad, f);
        }
    }
    ...
    public partial class AutoGradCumSumCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var cumulated = (Tensor<float32>)(Variable)OnnxOp.CumSum(data, Scalar(0L), exclusive: false, reverse: false);
    ...
    public partial class AutoGradCumSumReverseCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var cumulated = (Tensor<float32>)(Variable)OnnxOp.CumSum(data, Scalar(0L), exclusive: false, reverse: true);
            var loss = cumulated.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(6f)).Abs() < Scalar(1e-4f);
        }
    ...
    public partial class AutoGradCumSumWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var cumulated = (Tensor<float32>)(Variable)OnnxOp.CumSum(data, Scalar(0L), exclusive: false, reverse: false);
    ...
    public partial class AutoGradDet2x2IdentityCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Det(mat)).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(1f)).Abs() < Scalar(1e-3f);
        }
        ...
        {
            var flat = (Tensor<float32>)(Variable)OnnxOp.Concat([
                OnnxOp.Unsqueeze(a, Vector(0L)),
                OnnxOp.Unsqueeze(b, Vector(0L)),
                OnnxOp.Unsqueeze(c, Vector(0L)),
                OnnxOp.Unsqueeze(d, Vector(0L)),
            ], axis: 0);
            return (Tensor<float32>)(Variable)OnnxOp.Reshape(flat, Vector(2L, 2L), allowZero: false);
        }
    }
    ...
    public partial class AutoGradDet2x2ChainRuleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var det_val = ((Tensor<float32>)(Variable)OnnxOp.Det(mat)).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
    ...
    public partial class AutoGradCastLikeCheck
    {
        ...
        {
            var casted = (Tensor<float32>)(Variable)OnnxOp.CastLike(a, target, saturate: null);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(casted, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(1f)).Abs() < Scalar(1e-4f);
        }
    }
    ...
    public partial class AutoGradCastLikeWithScaleCheck
    {
        ...
        {
            var casted = (Tensor<float32>)(Variable)OnnxOp.CastLike(a, target, saturate: null);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(casted, Vector(new long[0]), allowZero: false)).Scalar() * Scalar(3f);
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradReduceProdCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.Prod, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradReduceSumSquareCheck
    {
        ...
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.SumSquare, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradReduceLogSumExpCheck
    {
        ...
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.LogSumExp, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradReduceL1Check
    {
        ...
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.L1, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradReduceL2Check
    {
        ...
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.L2, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradReduceLogSumCheck
    {
        ...
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.LogSum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradReduceMaxCheck
    {
        ...
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.Max, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradReduceMinCheck
    {
        ...
        {
            Func<Scalar<float32>, Scalar<float32>> f = z =>
                ((Tensor<float32>)(Variable)OnnxOp.Expand(z, Vector(2L))).Reduce(ReduceKind.Min, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, f(a));
            return AutoGradCheckHelpers.ScalarDirectionalDerivCheck(a, grad, f);
        }
    }
    ...
    public partial class AutoGradOptionalWrapUnwrap2x3Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var optional = OnnxOp.Optional(mat, DataStructure.Tensor, DType.Float32);
            var extracted = (Tensor<float32>)(Variable)OnnxOp.OptionalGetElement(optional);
    ...
    public partial class AutoGradOptionalWrapUnwrapScalarCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var tensor = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L));
    ...
    public partial class AutoGradOptionalWrapUnwrap3x4Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L, 4L));
            var optional = OnnxOp.Optional(mat, DataStructure.Tensor, DType.Float32);
            var extracted = (Tensor<float32>)(Variable)OnnxOp.OptionalGetElement(optional);
            var loss = extracted.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradOptionalWrapUnwrapWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 2L));
    ...
    public partial class AutoGradConcat2Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L), allowZero: false);
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b, Vector(1L), allowZero: false);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Concat([aVec, bVec], axis: 0))
    ...
    public partial class AutoGradConcatWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b, Vector(1L), allowZero: false);
            var concatenated = (Tensor<float32>)(Variable)OnnxOp.Concat([aVec, bVec], axis: 0);
    ...
    public partial class AutoGradConcat3Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L), allowZero: false);
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b, Vector(1L), allowZero: false);
            var cVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(c, Vector(1L), allowZero: false);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Concat([aVec, bVec, cVec], axis: 0))
                .Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad([(IValue)a, b, c], loss);
            var gradA = (Scalar<float32>)(Variable)grads[0]!;
            var gradB = (Scalar<float32>)(Variable)grads[1]!;
            var gradC = (Scalar<float32>)(Variable)grads[2]!;
            var okA = (gradA - Scalar(1f)).Abs() < Scalar(1e-3f);
            var okB = (gradB - Scalar(1f)).Abs() < Scalar(1e-3f);
    ...
    public partial class AutoGradConcatWithActivationCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(a.Relu(), Vector(1L), allowZero: false);
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b.Relu(), Vector(1L), allowZero: false);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Concat([aVec, bVec], axis: 0))
                .Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
            var okA = (gradA! - Scalar(1f)).Abs() < Scalar(1e-3f);
    ...
    public partial class AutoGradSplit3OutputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var combined = (Tensor<float32>)(Variable)OnnxOp.Concat([splits[0], splits[1], splits[2]], axis: 0);
            var loss = combined.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradIfMultiOutputPartiallyUsedCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            ...
            var loss = (Scalar<float32>)(Variable)out0;
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradGlobalAveragePoolCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var pooled = (Tensor<float32>)(Variable)OnnxOp.GlobalAveragePool(expanded);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(pooled, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(1f)).Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradGlobalAveragePoolWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var pooled = (Tensor<float32>)(Variable)OnnxOp.GlobalAveragePool(expanded);
            var loss = (((Tensor<float32>)(Variable)OnnxOp.Reshape(pooled, Vector(new long[0]), allowZero: false)).Scalar()) * Scalar(2f);
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradGlobalMaxPoolCheck
    {
        ...
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var pooled = (Tensor<float32>)(Variable)OnnxOp.GlobalMaxPool(expanded);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(pooled, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(1f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradGlobalAveragePoolExpChainCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(1L, 1L, 2L, 2L));
            var expX = (Tensor<float32>)(Variable)OnnxOp.Exp(expanded);
            var pooled = (Tensor<float32>)(Variable)OnnxOp.GlobalAveragePool(expX);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(pooled, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    public partial class AutoGradGlobalLpPoolP2Check
    {
        ...
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var pooled = (Tensor<float32>)(Variable)OnnxOp.GlobalLpPool(expanded, 2);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(pooled, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradGlobalLpPoolP1Check
    {
        ...
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var pooled = (Tensor<float32>)(Variable)OnnxOp.GlobalLpPool(expanded, 1);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(pooled, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradGlobalLpPoolP2WithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var pooled = (Tensor<float32>)(Variable)OnnxOp.GlobalLpPool(expanded, 2);
            var loss = (((Tensor<float32>)(Variable)OnnxOp.Reshape(pooled, Vector(new long[0]), allowZero: false)).Scalar()) * Scalar(3f);
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(6f)).Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradLpPoolP2Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 4L, 4L));
            var pooled = (Tensor<float32>)(Variable)OnnxOp.LpPool(expanded,
    ...
    public partial class AutoGradMaxUnpoolCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var unpooled = (Tensor<float32>)(Variable)OnnxOp.MaxUnpool(pooled, indices,
                kernelShape: [2L, 2L], strides: [2L, 2L]);
    ...
    public partial class AutoGradDropoutInferenceCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var (output, _) = OnnxOp.Dropout(aVec, null, null);
            var loss = ((Tensor<float32>)(Variable)output).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(3f)).Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradDropoutWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var (output, _) = OnnxOp.Dropout(aVec, null, null);
            var loss = ((Tensor<float32>)(Variable)output).Reduce(ReduceKind.Sum, keepDims: false).Scalar() * Scalar(2f);
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradDropoutWithDownstreamCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var (output, _) = OnnxOp.Dropout(aVec, null, null);
            var combined = (Tensor<float32>)(Variable)output + aVec;
            var loss = combined.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradSum2InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Sum(a, b);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
            var okA = (gradA! - Scalar(1f)).Abs() < Scalar(1e-3f);
            var okB = (gradB! - Scalar(1f)).Abs() < Scalar(1e-3f);
            return okA & okB;
    ...
    public partial class AutoGradSum3InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Sum(a, b, c);
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad([(IValue)a, b, c], loss);
            var gradA = (Scalar<float32>)(Variable)grads[0]!;
            var gradB = (Scalar<float32>)(Variable)grads[1]!;
            var gradC = (Scalar<float32>)(Variable)grads[2]!;
    ...
    public partial class AutoGradSumWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = ((Scalar<float32>)(Variable)OnnxOp.Sum(a, b)) * Scalar(3f);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
    ...
    public partial class AutoGradSumTensorInputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Expand(b, Vector(2L));
            var sumResult = (Tensor<float32>)(Variable)OnnxOp.Sum(aVec, bVec);
    ...
    public partial class AutoGradMean2InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Mean(a, b);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
    ...
    public partial class AutoGradMean3InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Mean(a, b, c);
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad([(IValue)a, b, c], loss);
            var gradA = (Scalar<float32>)(Variable)grads[0]!;
            var gradB = (Scalar<float32>)(Variable)grads[1]!;
            var gradC = (Scalar<float32>)(Variable)grads[2]!;
    ...
    public partial class AutoGradMeanWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = ((Scalar<float32>)(Variable)OnnxOp.Mean(a, b)) * Scalar(6f);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
            return (gradA! - Scalar(3f)).Abs() < Scalar(1e-3f)
                & (gradB! - Scalar(3f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradMeanTensorInputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Expand(b, Vector(2L));
            var meanResult = (Tensor<float32>)(Variable)OnnxOp.Mean(aVec, bVec);
    ...
    public partial class AutoGradMax2InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Max(a, b);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
    ...
    public partial class AutoGradMax3InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Max(a, b, c);
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad([(IValue)a, b, c], loss);
            var gradA = (Scalar<float32>)(Variable)grads[0]!;
            var gradB = (Scalar<float32>)(Variable)grads[1]!;
            var gradC = (Scalar<float32>)(Variable)grads[2]!;
    ...
    public partial class AutoGradMaxWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = ((Scalar<float32>)(Variable)OnnxOp.Max(a, b)) * Scalar(3f);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
            return gradA!.Abs() < Scalar(1e-3f)
                & (gradB! - Scalar(3f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradMaxTensorInputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Expand(b, Vector(2L));
            var maxResult = (Tensor<float32>)(Variable)OnnxOp.Max(aVec, bVec);
    ...
    public partial class AutoGradMin2InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Min(a, b);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
            return (gradA! - Scalar(1f)).Abs() < Scalar(1e-3f)
    ...
    public partial class AutoGradMin3InputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            var loss = (Scalar<float32>)(Variable)OnnxOp.Min(a, b, c);
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad([(IValue)a, b, c], loss);
            var gradA = (Scalar<float32>)(Variable)grads[0]!;
            var gradB = (Scalar<float32>)(Variable)grads[1]!;
            var gradC = (Scalar<float32>)(Variable)grads[2]!;
    ...
    public partial class AutoGradMinWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var loss = ((Scalar<float32>)(Variable)OnnxOp.Min(a, b)) * Scalar(4f);
            var (gradA, gradB) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
            return gradA!.Abs() < Scalar(1e-3f)
    ...
    public partial class AutoGradMinTensorInputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Expand(b, Vector(2L));
            var minResult = (Tensor<float32>)(Variable)OnnxOp.Min(aVec, bVec);
    ...
    public partial class AutoGradEinsumMatmulBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(a, Vector(0L));
            var flat = (Tensor<float32>)(Variable)OnnxOp.Concat([aVec, Vector(0f), Vector(0f), Vector(1f)], axis: 0);
            var A = (Tensor<float32>)(Variable)OnnxOp.Reshape(flat, Vector(2L, 2L), allowZero: false);
            var B = (Tensor<float32>)(Variable)OnnxOp.Reshape(Vector(1f, 1f, 1f, 1f), Vector(2L, 2L), allowZero: false);
            var C = (Tensor<float32>)(Variable)OnnxOp.Einsum([A, B], equation: "ij,jk->ik");
    ...
    public partial class AutoGradEinsumTransposeCheck
    {
        ...
        {
            var aVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(a, Vector(0L));
            var flat = (Tensor<float32>)(Variable)OnnxOp.Concat([aVec, Vector(2f), Vector(3f), Vector(4f)], axis: 0);
            var A = (Tensor<float32>)(Variable)OnnxOp.Reshape(flat, Vector(2L, 2L), allowZero: false);
            var At = (Tensor<float32>)(Variable)OnnxOp.Einsum([A], equation: "ij->ji");
    ...
    public partial class AutoGradEinsumImplicitModeCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var A = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var B = (Tensor<float32>)(Variable)OnnxOp.Reshape(Vector(1f, 1f, 1f, 1f, 1f, 1f), Vector(3L, 2L), allowZero: false);
            var C = (Tensor<float32>)(Variable)OnnxOp.Einsum([A, B], equation: "ij,jk");
            var loss = C.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(12f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradEinsumFreeIndexCheck
    {
        ...
        {
            var A = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var summed = (Tensor<float32>)(Variable)OnnxOp.Einsum([A], equation: "ij->j");
    ...
    public partial class AutoGradGemmBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aMat1 = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L));
            var aMat2 = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Gemm(aMat1, aMat2);
    ...
    public partial class AutoGradGemmWithAlphaCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aMat1 = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L));
            var aMat2 = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Gemm(aMat1, aMat2, alpha: 2.0f);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradGemmWithBetaAndCCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aMat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Gemm(aMat, aMat, aMat, beta: 3.0f);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradGemmTransACheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aCol = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 1L));
            var bCol = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Gemm(aCol, bCol, transA: 1);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f) * a).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradGemmTransBCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var aRow = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L));
            var bRow = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Gemm(aRow, bRow, transB: 1);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f) * a).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradMatMulKnownRankCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var A = (Tensor<float32>)(Variable)OnnxOp.Identity(OnnxOp.Expand(a, Vector(2L, 3L)), rank: 2);
            var B = (Tensor<float32>)(Variable)OnnxOp.Identity(OnnxOp.Expand(a, Vector(3L, 2L)), rank: 2);
            var C = (Tensor<float32>)(Variable)OnnxOp.MatMul(A, B);
            var loss = C.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradMatMulUnknownRankBatchedCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var A = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 2L, 3L));
            var B = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L, 2L));
            var C = (Tensor<float32>)(Variable)OnnxOp.MatMul(A, B);
            var loss = C.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradReduceSumExplicitAxesKeepdimsTrueCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var reduced = (Tensor<float32>)(Variable)OnnxOp.ReduceSum(data, Vector(1L), keepdims: true, noopWithEmptyAxes: null);
    ...
    public partial class AutoGradReduceSumExplicitAxesKeepdimsFalseCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var reduced = (Tensor<float32>)(Variable)OnnxOp.ReduceSum(data, Vector(1L), keepdims: false, noopWithEmptyAxes: null);
            var loss = reduced.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(6f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradReduceMeanExplicitAxesCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var reduced = (Tensor<float32>)(Variable)OnnxOp.ReduceMean(data, Vector(1L), keepdims: false, noopWithEmptyAxes: null);
            var loss = reduced.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradAffineGridMultiBatchCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var translationValues = (Tensor<float32>)(Variable)OnnxOp.Constant(
                TensorData(12, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f));
            var thetaConst = (Tensor<float32>)(Variable)OnnxOp.Reshape(translationValues, Vector(2L, 2L, 3L), allowZero: false);
            var theta = (Tensor<float32>)(Variable)OnnxOp.Mul(thetaConst, a);
            var size = (Tensor<int64>)(Variable)OnnxOp.Constant(TensorData(4, 2L, 1L, 2L, 2L));
            var grid = (Tensor<float32>)(Variable)OnnxOp.AffineGrid(theta, size, alignCorners: true);
    ...
    public partial class AutoGradReshapePassthroughCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var reshaped = (Tensor<float32>)(Variable)OnnxOp.Reshape(x, Vector(1L), allowZero: false);
            var product = (Tensor<float32>)(Variable)OnnxOp.Mul(reshaped, Scalar(2f));
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(product, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradBatchNormSimpleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var x = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L));
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(2L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var mean = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var variance = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(2L));
            var bn = (Tensor<float32>)(Variable)OnnxOp.BatchNormalization(x, scale, bias, mean, variance,
    ...
    public partial class AutoGradBatchNormWithScaleCheck
    {
        ...
        {
            var x = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L));
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(2f), Vector(2L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var mean = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var variance = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(2L));
            var bn = (Tensor<float32>)(Variable)OnnxOp.BatchNormalization(x, scale, bias, mean, variance,
    ...
    public partial class AutoGradBatchNorm3DCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var x = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L, 3L));
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(2L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var mean = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var variance = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(2L));
    ...
    public partial class AutoGradGroupNormBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L, 1L, 1L));
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(2L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.GroupNormalization(input, scale, bias,
    ...
    public partial class AutoGradGroupNormScaleCheck
    {
        ...
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(2f), Vector(1L, 2L, 1L, 2L));
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(s, Vector(2L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.GroupNormalization(input, scale, bias,
    ...
    public partial class AutoGradGroupNorm2GroupsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var input = (Tensor<float32>)(Variable)OnnxOp.Reshape(vals, Vector(1L, 4L, 1L, 1L), allowZero: false);
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(4L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(4L));
            var output = (Tensor<float32>)(Variable)OnnxOp.GroupNormalization(input, scale, bias,
                epsilon: 1e-5f, numGroups: 2);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradInstanceNormBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                OnnxOp.Concat([
                    (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L), allowZero: false),
                    (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(2f), Vector(1L), allowZero: false),
                    (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(3f), Vector(1L), allowZero: false),
                    (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(4f), Vector(1L), allowZero: false)
                ], axis: 0),
                Vector(1L, 1L, 2L, 2L), allowZero: false);
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(1L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.InstanceNormalization(input, scale, bias, epsilon: 1e-5f);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return grad.Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradInstanceNormWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                ...
                Vector(1L, 1L, 2L, 2L), allowZero: false);
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(2f), Vector(1L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.InstanceNormalization(input, scale, bias);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return grad.Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradLpNormL2BasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.LpNormalization(input, axis: 0, p: 2);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return grad.Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradLpNormL1BasicCheck
    {
        ...
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.LpNormalization(input, axis: 0, p: 1);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return grad.Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradLayerNormalizationCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Concat([
                (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L), allowZero: false),
                (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(2f), Vector(1L), allowZero: false),
                (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(3f), Vector(1L), allowZero: false),
                (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(4f), Vector(1L), allowZero: false),
            ...
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(4L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0f), Vector(4L));
            var output = (Tensor<float32>)(Variable)OnnxOp.LayerNormalization(input, scale, bias, axis: -1, epsilon: 1e-5f).y;
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradMeanVarianceNormalizationCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var output = (Tensor<float32>)(Variable)OnnxOp.MeanVarianceNormalization(input, axes: [0L]);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return grad.Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradLogSoftmaxCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var logSoft = (Tensor<float32>)(Variable)OnnxOp.LogSoftmax(input, axis: -1);
    ...
    public partial class AutoGradPReluCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Concat([
                (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L), allowZero: false),
                (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(-1f), Vector(1L), allowZero: false),
                (Tensor<float32>)(Variable)OnnxOp.Reshape(a * Scalar(2f), Vector(1L), allowZero: false),
            ], axis: 0);
            var slope = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1f), Vector(3L));
            var output = (Tensor<float32>)(Variable)OnnxOp.PRelu(input, slope);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradNegativeLogLikelihoodLossCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var scores = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var target = Vector(0L, 1L);
            var loss = ((Tensor<float32>)(Variable)OnnxOp.NegativeLogLikelihoodLoss(
    ...
    public partial class AutoGradSoftmaxCrossEntropyLossLogProbCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var (output, logProb) = OnnxOp.SoftmaxCrossEntropyLoss(
                scores, labels, weights: null, ignoreIndex: null, reduction: "sum");
            var lossLoss = ((Tensor<float32>)(Variable)output).Scalar();
            var lossLp = ((Tensor<float32>)(Variable)logProb!).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
    ...
    public partial class AutoGradNegativeLogLikelihoodLossNoneCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var scores = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var target = Vector(0L, 1L);
            var lossPer = (Tensor<float32>)(Variable)OnnxOp.NegativeLogLikelihoodLoss(
    ...
    public partial class AutoGradSoftmaxCrossEntropyLossNoneCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var lossPer = (Tensor<float32>)(Variable)output;
            var loss = lossPer.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return grad.Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradSoftmaxCrossEntropyLossOnlyLogProbCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var (_, logProb) = OnnxOp.SoftmaxCrossEntropyLoss(
                scores, labels, weights: null, ignoreIndex: null, reduction: "sum");
            var loss = ((Tensor<float32>)(Variable)logProb!).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return grad.Abs() < Scalar(1e-3f);
        }
    }
    ...
    public partial class AutoGradSplitToSequenceCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var recombined = (Tensor<float32>)(Variable)OnnxOp.ConcatFromSequence(seq, axis: 0, newAxis: false);
            var loss = recombined.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradGatherElementsAxis0Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var gathered = (Tensor<float32>)(Variable)OnnxOp.GatherElements(data, indices, axis: 0);
    ...
    public partial class AutoGradGatherElementsAxis1Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var indices = (Tensor<int64>)(Variable)OnnxOp.Reshape(Vector(1L, 0L, 0L, 1L), Vector(2L, 2L), allowZero: false);
            var gathered = (Tensor<float32>)(Variable)OnnxOp.GatherElements(data, indices, axis: 1);
            var loss = gathered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradScatterElementsAddCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var updates = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L));
            var indices = Vector(1L);
            var scattered = (Tensor<float32>)(Variable)OnnxOp.ScatterElements(data, indices, updates,
    ...
    public partial class AutoGradScatterElementsNoneCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var updates = (Tensor<float32>)(Variable)OnnxOp.Reshape(updateVal, Vector(1L), allowZero: false);
    ...
    public partial class AutoGradScatterNDAddCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var scattered = (Tensor<float32>)(Variable)OnnxOp.ScatterND(data, indices, updates, ScatterNDReduction.Add);
            var loss = scattered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradScatterNDNoneCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var updateVal = a * Scalar(2f);
            var updates = (Tensor<float32>)(Variable)OnnxOp.Reshape(updateVal, Vector(1L), allowZero: false);
            var indices = (Tensor<int64>)(Variable)OnnxOp.Reshape(Vector(0L), Vector(1L, 1L), allowZero: false);
            var scattered = (Tensor<float32>)(Variable)OnnxOp.ScatterND(data, indices, updates);
            var loss = scattered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradScatterNDReluChainCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var indices = (Tensor<int64>)(Variable)OnnxOp.Reshape(Vector(1L), Vector(1L, 1L), allowZero: false);
            var scattered = (Tensor<float32>)(Variable)OnnxOp.ScatterND(data, indices, updates, ScatterNDReduction.Add);
            var activated = (Tensor<float32>)(Variable)OnnxOp.Relu(scattered);
    ...
    public partial class AutoGradGatherAxis0Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var indices = Vector(0L);
            var gathered = (Tensor<float32>)(Variable)OnnxOp.Gather(data, indices, axis: 0);
            var loss = gathered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradGatherAxis0MultiDimIndicesCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L, 4L));
            var indices = (Tensor<int64>)(Variable)OnnxOp.Reshape(Vector(0L, 1L), Vector(1L, 2L), allowZero: false);
            var gathered = (Tensor<float32>)(Variable)OnnxOp.Gather(data, indices, axis: 0);
            var loss = gathered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradGatherNonZeroAxisOneDimIndicesCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Identity(OnnxOp.Expand(a, Vector(2L, 3L)), rank: 2);
            var indices = Vector(1L);
            var gathered = (Tensor<float32>)(Variable)OnnxOp.Gather(data, indices, axis: 1);
            var loss = gathered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradGatherNonZeroAxisOneDimIndicesUnknownRankCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L)); // no rank stamp → null static rank
            var indices = Vector(1L);
            var gathered = (Tensor<float32>)(Variable)OnnxOp.Gather(data, indices, axis: 1);
            var loss = gathered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradGatherNonZeroAxisMultiDimIndicesCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Identity(OnnxOp.Expand(a, Vector(2L, 3L)), rank: 2);
            var indices = (Tensor<int64>)(Variable)OnnxOp.Identity(
    ...
    public partial class AutoGradGatherNDCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var indices = (Tensor<int64>)(Variable)OnnxOp.Reshape(Vector(0L, 2L), Vector(2L, 1L), allowZero: false);
            var gathered = (Tensor<float32>)(Variable)OnnxOp.GatherND(data, indices);
            var loss = gathered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradGatherNDDuplicateIndicesCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var indices = (Tensor<int64>)(Variable)OnnxOp.Reshape(Vector(0L, 0L, 0L), Vector(3L, 1L), allowZero: false);
            var gathered = (Tensor<float32>)(Variable)OnnxOp.GatherND(data, indices);
            var loss = gathered.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(3f)).Abs() < Scalar(1e-5f);
    ...
    public partial class AutoGradWhereTrueBranchCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x, Scalar<float32> y)
        {
            ...
            var result = (Tensor<float32>)(Variable)OnnxOp.Where(cond, x, y);
    ...
    public partial class AutoGradUniqueSingleElementCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L));
    ...
    public partial class AutoGradUniqueAllSameCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(4L));
    ...
    public partial class AutoGradUniqueWithAxisCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L, 2L));
    ...
    public partial class AutoGradTransposeCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var reshaped = (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L, 1L), allowZero: false);
            var transposed = reshaped.Transpose();
            var product = (Tensor<float32>)(Variable)OnnxOp.Mul(transposed, Scalar(3f));
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(product, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(3f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradFlattenCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var reshaped = (Tensor<float32>)(Variable)OnnxOp.Reshape(x, Vector(1L, 1L), allowZero: false);
            var flattened = (Tensor<float32>)(Variable)OnnxOp.Flatten(reshaped, axis: 0);
            var product = (Tensor<float32>)(Variable)OnnxOp.Mul(flattened, Scalar(2f));
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(product, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradSqueezeCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var unsqueezed = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(x, Vector(0L));
            var squeezed = (Tensor<float32>)(Variable)OnnxOp.Squeeze(unsqueezed, Vector(0L));
    ...
    public partial class AutoGradUnsqueezeCheck
    {
        ...
        {
            var unsqueezed = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(x, Vector(0L));
            var product = (Tensor<float32>)(Variable)OnnxOp.Mul(unsqueezed, Scalar(2f));
            var loss = ((Tensor<float32>)(Variable)OnnxOp.Reshape(product, Vector(new long[0]), allowZero: false)).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradExpandCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(2L));
    ...
    public partial class AutoGradPadConstantCheck
    {
        ...
        {
            var reshaped = (Tensor<float32>)(Variable)OnnxOp.Reshape(x, Vector(1L), allowZero: false);
            var padded = (Tensor<float32>)(Variable)OnnxOp.Pad(reshaped, Vector(1L, 1L), Scalar(0f), mode: PadMode.Constant);
            var loss = padded.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            return (grad - Scalar(1f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradPad2DCheck
    {
        ...
        {
            var reshaped = (Tensor<float32>)(Variable)OnnxOp.Reshape(x, Vector(1L, 1L), allowZero: false);
            var padded = (Tensor<float32>)(Variable)OnnxOp.Pad(reshaped, Vector(1L, 1L, 1L, 1L), Scalar(0f), mode: PadMode.Constant);
            var loss = padded.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            return (grad - Scalar(1f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradPadWithSigmoidCheck
    {
        ...
        {
            var sigX = x.Sigmoid();
            var reshaped = (Tensor<float32>)(Variable)OnnxOp.Reshape(sigX, Vector(1L), allowZero: false);
            var padded = (Tensor<float32>)(Variable)OnnxOp.Pad(reshaped, Vector(1L, 1L), Scalar(0f), mode: PadMode.Constant);
            var loss = padded.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    public partial class AutoGradResizeNearestSumLossWithScalesCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var scales = Vector(1.0f, 1.0f, 2.0f, 2.0f);
            var resized = (Tensor<float32>)(Variable)OnnxOp.Resize(mat, null, scales, null,
    ...
    public partial class AutoGradResizeNearestSizesCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var resized = (Tensor<float32>)(Variable)OnnxOp.Resize(mat, null, null, sizes,
                antialias: false, axes: null,
                coordinateTransformationMode: CoordinateTransformationMode.Asymmetric,
                cubicCoeffA: null, excludeOutside: false,
                extrapolationValue: null, keepAspectRatioPolicy: null,
    ...
    public partial class AutoGradResizeNearestChainedCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 1L, 1L));
            var scales = Vector(1.0f, 1.0f, 2.0f, 2.0f);
            var resized = (Tensor<float32>)(Variable)OnnxOp.Resize(mat, null, scales, null,
                antialias: false, axes: null,
                coordinateTransformationMode: CoordinateTransformationMode.Asymmetric,
    ...
    public partial class AutoGradResizeNearestMultipleInputsCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            var ch1 = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 1L, 1L));
            var ch2 = (Tensor<float32>)(Variable)OnnxOp.Expand(b, Vector(1L, 1L, 1L, 1L));
            var mat = (Tensor<float32>)(Variable)OnnxOp.Concat([ch1, ch2], axis: 1);
            var scales = Vector(1.0f, 1.0f, 2.0f, 2.0f);
            var resized = (Tensor<float32>)(Variable)OnnxOp.Resize(mat, null, scales, null,
                antialias: false, axes: null,
                coordinateTransformationMode: CoordinateTransformationMode.Asymmetric,
    ...
    public partial class AutoGradSliceCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var sliced = (Tensor<float32>)(Variable)OnnxOp.Slice(data, Vector(1L), Vector(2L));
    ...
    public partial class AutoGradSliceMultipleElementsCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var sliced = (Tensor<float32>)(Variable)OnnxOp.Slice(data, Vector(0L), Vector(2L));
            var loss = sliced.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(2f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradSliceWithScaleCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L));
            var sliced = (Tensor<float32>)(Variable)OnnxOp.Slice(data, Vector(0L), Vector(3L));
    ...
    public partial class AutoGradSpaceToDepthBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.SpaceToDepth(input, blockSize: 2);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradSpaceToDepthMultiChannelCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L, 2L, 2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.SpaceToDepth(input, blockSize: 2);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(8f)).Abs() < Scalar(1e-5f);
    ...
    public partial class AutoGradDepthToSpaceDCRCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 4L, 1L, 1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.DepthToSpace(input, blockSize: 2, mode: DepthColumnRowMode.DCR);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradDepthToSpaceCRDCheck
    {
        ...
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 4L, 1L, 1L));
            var output = (Tensor<float32>)(Variable)OnnxOp.DepthToSpace(input, blockSize: 2, mode: DepthColumnRowMode.CRD);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradTile1DCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L), allowZero: false);
            var tiled = (Tensor<float32>)(Variable)OnnxOp.Tile(data, Vector(3L));
            var loss = tiled.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(3f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradTileWithScaleCheck
    {
        ...
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L), allowZero: false);
            var tiled = (Tensor<float32>)(Variable)OnnxOp.Tile(data, Vector(4L));
    ...
    public partial class AutoGradTile2DCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var data = (Tensor<float32>)(Variable)OnnxOp.Reshape(a, Vector(1L, 1L), allowZero: false);
            var tiled = (Tensor<float32>)(Variable)OnnxOp.Tile(data, Vector(2L, 3L));
            var loss = tiled.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(6f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradTriluUpperCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Trilu(input, upper: 1);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(3f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradTriluLowerCheck
    {
        ...
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 2L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Trilu(input, upper: 0);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(3f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradTriluUpperWithKCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(3L, 3L));
            var output = (Tensor<float32>)(Variable)OnnxOp.Trilu(input, Scalar(1L), upper: 1);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(3f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradUpsampleNearestSumLossCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 2L, 2L));
            var scales = Vector(1.0f, 1.0f, 2.0f, 2.0f);
            var upsampled = (Tensor<float32>)(Variable)OnnxOp.Upsample(mat, scales, mode: ResizeMode.Nearest);
    ...
    public partial class AutoGradCenterCropPadCropCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 4L));
    ...
    public partial class AutoGradReverseSequenceBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var reversed = (Tensor<float32>)(Variable)OnnxOp.ReverseSequence(mat, seqLens,
    ...
    public partial class AutoGradReverseSequenceBatchAxis1Check
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(4L, 2L));
    ...
    public partial class AutoGradCol2ImBasicNoOverlapCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L, 15L));
            var imgShape = Vector(3L, 5L);
            var blkShape = Vector(1L, 1L);
            var col2imOut = (Tensor<float32>)(Variable)OnnxOp.Col2Im(expanded, imgShape, blkShape,
    ...
    public partial class AutoGradCol2ImWithOverlapCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 4L, 4L));
    ...
    public partial class AutoGradCol2ImWithPaddingCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L, 35L));
            var imgShape = Vector(3L, 5L);
            var blkShape = Vector(1L, 1L);
            var col2imOut = (Tensor<float32>)(Variable)OnnxOp.Col2Im(expanded, imgShape, blkShape,
    ...
    public partial class AutoGradCol2Im1x1BlockCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 6L));
    ...
    public partial class AutoGradSequenceConstructAtExtractFirstCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            ...
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq, Scalar(0L));
    ...
    public partial class AutoGradSequenceConstructAtExtractSecondCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            ...
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b, Vector(1L), allowZero: false);
            var seq = OnnxOp.SequenceConstruct(aVec, bVec);
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq, Scalar(1L));
            var loss = elem.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var (ga, gb) = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, b, loss);
    ...
    public partial class AutoGradSequenceConstructAtWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            ...
            var seq = OnnxOp.SequenceConstruct(aVec, bVec);
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq, Scalar(0L));
            var threeVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(Scalar(3f), Vector(1L), allowZero: false);
    ...
    public partial class AutoGradConcatFromSequenceBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            ...
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b, Vector(1L), allowZero: false);
            var seq = OnnxOp.SequenceConstruct(aVec, bVec);
            var concatenated = (Tensor<float32>)(Variable)OnnxOp.ConcatFromSequence(seq, axis: 0, newAxis: false);
    ...
    public partial class AutoGradConcatFromSequenceNewAxisCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b)
        {
            ...
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b, Vector(1L), allowZero: false);
            var seq = OnnxOp.SequenceConstruct(aVec, bVec);
            var stacked = (Tensor<float32>)(Variable)OnnxOp.ConcatFromSequence(seq, axis: 0, newAxis: true);
    ...
    public partial class AutoGradSequenceInsertAtPositionCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            ...
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seqInserted, Scalar(1L));
            var loss = elem.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(new IValue[] { a, b, c }, loss);
            var ga = (Scalar<float32>)(Variable)grads[0]!;
            var gb = (Scalar<float32>)(Variable)grads[1]!;
            var gc = (Scalar<float32>)(Variable)grads[2]!;
            var okA = ga.Abs() < Scalar(1e-5f);
            var okB = gb.Abs() < Scalar(1e-5f);
    ...
    public partial class AutoGradSequenceInsertAppendNullPositionCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            ...
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seqAppended, Scalar(2L));
            var loss = elem.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(new IValue[] { a, b, c }, loss);
            var ga = (Scalar<float32>)(Variable)grads[0]!;
            var gb = (Scalar<float32>)(Variable)grads[1]!;
    ...
    public partial class AutoGradSequenceEraseElementCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c)
        {
            ...
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seqErased, Scalar(0L));
            var loss = elem.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(new IValue[] { a, b, c }, loss);
            var ga = (Scalar<float32>)(Variable)grads[0]!;
            var gb = (Scalar<float32>)(Variable)grads[1]!;
    ...
    public partial class AutoGradCompressNoAxisCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var compressed = (Tensor<float32>)(Variable)OnnxOp.Compress(expanded, condition, axis: null);
    ...
    public partial class AutoGradCompressWithAxisCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var condition = Vector(true, true, false);
            var compressed = (Tensor<float32>)(Variable)OnnxOp.Compress(expanded, condition, axis: 1);
            var loss = compressed.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradCompressWithAxisZeroCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var compressed = (Tensor<float32>)(Variable)OnnxOp.Compress(expanded, condition, axis: 0);
            var loss = compressed.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradDftRoundtripCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L, 2L));
            var axis = Scalar(1L);
            var dftOut = OnnxOp.Dft(expanded, null, axis, inverse: false, onesided: false);
            var axis2 = Scalar(1L);
            var idftOut = (Tensor<float32>)(Variable)OnnxOp.Dft(dftOut, null, axis2, inverse: true, onesided: false);
    ...
    public partial class AutoGradConstantOfShapeNullShapeGradientCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var ones = (Tensor<float32>)(Variable)OnnxOp.ConstantOfShape(shape, TensorData(DType.Float32, [1L], 1f));
            var aMat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
    ...
    public partial class AutoGradDftDefaultAxisCheck
    {
        ...
        {
            var expanded = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 2L, 2L));
            var dftOut = (Tensor<float32>)(Variable)OnnxOp.Dft(expanded, null, null, inverse: false, onesided: false);
    ...
    public partial class AutoGradGridSampleMultiChannelCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var inputVals = (Tensor<float32>)(Variable)OnnxOp.Constant(
                TensorData(8, 1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f));
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(inputVals, Vector(1L, 2L, 2L, 2L), allowZero: false), a);
            var gridVals = (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(2, 0f, 0f));
            var grid = (Tensor<float32>)(Variable)OnnxOp.Reshape(gridVals, Vector(1L, 1L, 1L, 2L), allowZero: false);
            var output = (Tensor<float32>)(Variable)OnnxOp.GridSample(x, grid,
    ...
    public partial class AutoGradTopK1DLargestK1Check
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var x_vec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(x, Vector(0L));
            var data = (Tensor<float32>)(Variable)OnnxOp.Concat([x_vec, Vector(1.0f), Vector(2.0f)], axis: 0);
            var (values, _) = OnnxOp.TopK(data, Vector(1L), axis: 0, largest: true, sorted: true);
            var loss = ((Tensor<float32>)(Variable)values).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            return (grad - Scalar(1f)).Abs() < Scalar(1e-5f);
        }
    }
    ...
    public partial class AutoGradTopKNotSelectedCheck
    {
        ...
        {
            var x_vec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(x, Vector(0L));
            var data = (Tensor<float32>)(Variable)OnnxOp.Concat([x_vec, Vector(10.0f), Vector(20.0f)], axis: 0);
            var (values, _) = OnnxOp.TopK(data, Vector(1L), axis: 0, largest: true, sorted: true);
            var loss = ((Tensor<float32>)(Variable)values).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
            return grad.Abs() < Scalar(1e-5f);
    ...
    public partial class AutoGradTopK2DAxis1Check
    {
        ...
        {
            var x_vec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(x, Vector(0L));
            var row0 = (Tensor<float32>)(Variable)OnnxOp.Concat([x_vec, Vector(1.0f), Vector(3.0f)], axis: 0);
            var row0_2d = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(row0, Vector(0L));
            var row1_2d = (Tensor<float32>)(Variable)OnnxOp.Reshape(Vector(4.0f, 5.0f, 6.0f), Vector(1L, 3L), allowZero: false);
            var data = (Tensor<float32>)(Variable)OnnxOp.Concat([row0_2d, row1_2d], axis: 0);
    ...
    public partial class AutoGradMaxRoiPoolPositiveCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(16, 1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f, 10f, 11f, 12f, 13f, 14f, 15f, 16f));
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 1L, 4L, 4L), allowZero: false), a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(5, 0f, 0f, 0f, 3f, 3f)),
                Vector(1L, 5L), allowZero: false);
            var output = (Tensor<float32>)(Variable)OnnxOp.MaxRoiPool(x, rois, pooledShape: [2L, 2L], spatialScale: 1.0f);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradMaxRoiPoolGradientShapeCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var input = (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(16, 1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f, 10f, 11f, 12f, 13f, 14f, 15f, 16f));
            var x = (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 1L, 4L, 4L), allowZero: false);
            // Force x to depend on a so the gradient is non-trivially routed (a * 1 + 0*x acts as identity-with-input-dep).
            x = (Tensor<float32>)(Variable)OnnxOp.Mul(x, a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(5, 0f, 0f, 0f, 3f, 3f)),
                Vector(1L, 5L), allowZero: false);
            var output = (Tensor<float32>)(Variable)OnnxOp.MaxRoiPool(x, rois, pooledShape: [2L, 2L], spatialScale: 1.0f);
    ...
    public partial class AutoGradMaxRoiPoolMultiChannelCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(18, 1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f, 10f, 11f, 12f, 13f, 14f, 15f, 16f, 17f, 18f));
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 2L, 3L, 3L), allowZero: false), a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(5, 0f, 0f, 0f, 2f, 2f)),
                Vector(1L, 5L), allowZero: false);
            var output = (Tensor<float32>)(Variable)OnnxOp.MaxRoiPool(x, rois, pooledShape: [1L, 1L], spatialScale: 1.0f);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
    ...
    public partial class AutoGradMaxRoiPoolMultipleRoisCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 1L, 4L, 4L), allowZero: false), a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(10, 0f, 0f, 0f, 1f, 1f, 0f, 2f, 2f, 3f, 3f)),
    ...
    public partial class AutoGradRoiAlignPositiveCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 1L, 4L, 4L), allowZero: false), a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(4, 0f, 0f, 3f, 3f)),
                Vector(1L, 4L), allowZero: false);
            var batchIdx = (Tensor<int64>)(Variable)OnnxOp.Constant(TensorData(1, 0L));
            var output = (Tensor<float32>)(Variable)OnnxOp.RoiAlign(x, rois, batchIdx,
    ...
    public partial class AutoGradRoiAlignSpatialScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            var input = (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(9, 1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f));
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 1L, 3L, 3L), allowZero: false), a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(4, 0f, 0f, 4f, 4f)),
                Vector(1L, 4L), allowZero: false);
            var batchIdx = (Tensor<int64>)(Variable)OnnxOp.Constant(TensorData(1, 0L));
            var output = (Tensor<float32>)(Variable)OnnxOp.RoiAlign(x, rois, batchIdx,
    ...
    public partial class AutoGradRoiAlignMultiChannelCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 2L, 3L, 3L), allowZero: false), a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(4, 0f, 0f, 2f, 2f)),
                Vector(1L, 4L), allowZero: false);
            var batchIdx = (Tensor<int64>)(Variable)OnnxOp.Constant(TensorData(1, 0L));
            var output = (Tensor<float32>)(Variable)OnnxOp.RoiAlign(x, rois, batchIdx,
                mode: RoiAlignMode.Avg, outputHeight: 1, outputWidth: 1,
    ...
    public partial class AutoGradRoiAlignMultipleRoisCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var x = (Tensor<float32>)(Variable)OnnxOp.Mul(
                (Tensor<float32>)(Variable)OnnxOp.Reshape(input, Vector(1L, 1L, 4L, 4L), allowZero: false), a);
            var rois = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                (Tensor<float32>)(Variable)OnnxOp.Constant(TensorData(8, 0f, 0f, 1f, 1f, 2f, 2f, 3f, 3f)),
                Vector(2L, 4L), allowZero: false);
            var batchIdx = (Tensor<int64>)(Variable)OnnxOp.Constant(TensorData(2, 0L, 0L));
            var output = (Tensor<float32>)(Variable)OnnxOp.RoiAlign(x, rois, batchIdx,
                mode: RoiAlignMode.Avg, outputHeight: 1, outputWidth: 1,
                samplingRatio: 2, spatialScale: 1.0f);
            var loss = output.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
    ...
    internal static class RecurrentTestData
    {
        ...
        {
            var xVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(xVal, Vector(0L));
            var rest = X3[1..(2 * seqLen)];
            var flat = (Tensor<float32>)(Variable)OnnxOp.Concat([xVec, Vector(rest)], axis: 0);
    ...
    [Module] public partial class AutoGradGruWCheck
    {
        ...
        {
            var wVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(wv, Vector(0L));
            var wFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([wVec, Vector(RecurrentTestData.GruW[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradGruRCheck
    {
        ...
        {
            var rVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(rv, Vector(0L));
            var rFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([rVec, Vector(RecurrentTestData.GruR[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradGruBCheck
    {
        ...
        {
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(bv, Vector(0L));
            var bFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([bVec, Vector(RecurrentTestData.GruB[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradGruH0Check
    {
        ...
        {
            var hVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(hv, Vector(0L));
            var hFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([hVec, Vector(0.1f)], axis: 0);
    ...
    [Module] public partial class AutoGradGruLinearBeforeResetCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> xv)
        {
            ...
            var loss = ((Tensor<float32>)(Variable)yh!).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(xv, loss);
    ...
    [Module] public partial class AutoGradRnnWCheck
    {
        ...
        {
            var wVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(wv, Vector(0L));
            var wFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([wVec, Vector(RecurrentTestData.RnnW[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradRnnRCheck
    {
        ...
        {
            var rVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(rv, Vector(0L));
            var rFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([rVec, Vector(RecurrentTestData.RnnR[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradRnnBCheck
    {
        ...
        {
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(bv, Vector(0L));
            var bFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([bVec, Vector(RecurrentTestData.RnnB[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradLstmWCheck
    {
        ...
        {
            var wVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(wv, Vector(0L));
            var wFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([wVec, Vector(RecurrentTestData.LstmW[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradLstmRCheck
    {
        ...
        {
            var rVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(rv, Vector(0L));
            var rFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([rVec, Vector(RecurrentTestData.LstmR[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradLstmBCheck
    {
        ...
        {
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(bv, Vector(0L));
            var bFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([bVec, Vector(RecurrentTestData.LstmB[1..])], axis: 0);
    ...
    [Module] public partial class AutoGradLstmC0Check
    {
        ...
        {
            var cVec = (Tensor<float32>)(Variable)OnnxOp.Unsqueeze(cv, Vector(0L));
            var cFlat = (Tensor<float32>)(Variable)OnnxOp.Concat([cVec, Vector(-0.05f)], axis: 0);
    ...
    [Module] public partial class AutoGradLrnBasicCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(1L, 3L, 1L, 1L));
            var y = (Tensor<float32>)(Variable)OnnxOp.Lrn(mat, alpha: 1.0f, beta: 0.5f, bias: 1.0f, size: 3);
    ...
    [Module] public partial class AutoGradLrnNumericalCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(1L, 3L, 2L, 2L));
            var y = (Tensor<float32>)(Variable)OnnxOp.Lrn(mat, alpha: 1.0f, beta: 0.5f, bias: 1.0f, size: 3);
            var loss = y.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    [Module] public partial class AutoGradLrnSmallAlphaCheck
    {
        ...
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(1L, 3L, 1L, 1L));
            var y = (Tensor<float32>)(Variable)OnnxOp.Lrn(mat, alpha: 0.0001f, beta: 0.75f, bias: 1.0f, size: 5);
            var loss = y.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    [Module] public partial class AutoGradLrnHighBetaCheck
    {
        ...
        {
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(1L, 3L, 1L, 1L));
            var y = (Tensor<float32>)(Variable)OnnxOp.Lrn(mat, alpha: 0.5f, beta: 2.0f, bias: 1.0f, size: 3);
            var loss = y.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    [Module] public partial class AutoGradLrnWithScaleCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            ...
            var mat = (Tensor<float32>)(Variable)OnnxOp.Expand(scaled, Vector(1L, 3L, 1L, 1L));
            var y = (Tensor<float32>)(Variable)OnnxOp.Lrn(mat, alpha: 1.0f, beta: 0.5f, bias: 1.0f, size: 3);
            var loss = y.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    [Module] public partial class AutoGradLrnMultiChannelCh1Check
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var ch1 = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(1L, 1L, 1L, 1L));
            var ch2 = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(2.0f), Vector(1L, 1L, 1L, 1L));
            var mat = (Tensor<float32>)(Variable)OnnxOp.Concat([ch1, ch2], axis: 1);
            var y = (Tensor<float32>)(Variable)OnnxOp.Lrn(mat, alpha: 1.0f, beta: 0.5f, bias: 1.0f, size: 3);
            var loss = y.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    [Module] public partial class AutoGradLrnMultiChannelCh2Check
    {
        public static Scalar<bit> Inline(Scalar<float32> x)
        {
            var ch1 = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(1.0f), Vector(1L, 1L, 1L, 1L));
            var ch2 = (Tensor<float32>)(Variable)OnnxOp.Expand(x, Vector(1L, 1L, 1L, 1L));
            var mat = (Tensor<float32>)(Variable)OnnxOp.Concat([ch1, ch2], axis: 1);
            var y = (Tensor<float32>)(Variable)OnnxOp.Lrn(mat, alpha: 1.0f, beta: 0.5f, bias: 1.0f, size: 3);
            var loss = y.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, loss);
    ...
    [Module] public partial class AutoGradAffineGridAlignCornersFalseCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var theta = (Tensor<float32>)(Variable)OnnxOp.Mul(thetaConst, a);
            var size = (Tensor<int64>)(Variable)OnnxOp.Constant(TensorData(4, 2L, 1L, 2L, 2L));
            var grid = (Tensor<float32>)(Variable)OnnxOp.AffineGrid(theta, size, alignCorners: false);
            var loss = grid.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(8f)).Abs() < Scalar(1e-5f);
        }
    ...
    public partial class AutoGradDftWithDftLengthCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a)
        {
            ...
            var axis = Scalar(1L);
            var dftOut = (Tensor<float32>)(Variable)OnnxOp.Dft(expanded, dftLength, axis, inverse: false, onesided: false);
            var loss = dftOut.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(4f)).Abs() < Scalar(1e-3f);
        }
    ...
    public partial class AutoGradConstantOfShapeRuntimeShapeCheck
    {
        ...
        {
            var aMat = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(2L, 3L));
            var dynShape = (Tensor<int64>)(Variable)OnnxOp.Shape(aMat);
            var ones = (Tensor<float32>)(Variable)OnnxOp.ConstantOfShape(dynShape, TensorData(DType.Float32, [1L], 1f));
            var product = ones * aMat;
            var loss = product.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grad = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(a, loss);
            return (grad - Scalar(6f)).Abs() < Scalar(1e-3f);
    ...
    public partial class AutoGradSeqAtRuntimeIdxCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> idxF)
        {
            ...
            var bVec = (Tensor<float32>)(Variable)OnnxOp.Reshape(b, Vector(1L), allowZero: false);
            var seq = OnnxOp.SequenceConstruct(aVec, bVec);
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq, idx);
            var loss = elem.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
    ...
    public partial class AutoGradSeqInsertAppendCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> idxF)
        {
            ...
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq1, pos);
            var loss = elem.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
            var grads = Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad([(IValue)a, b, idxF], loss);
            var gradA = (Scalar<float32>)(Variable)grads[0]!;
            var gradB = (Scalar<float32>)(Variable)grads[1]!;
    ...
    public partial class AutoGradSeqInsertEraseRuntimeIdxCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> a, Scalar<float32> b, Scalar<float32> c, Scalar<float32> idxF)
        {
            ...
            var elem = (Tensor<float32>)(Variable)OnnxOp.SequenceAt(seq2, pos);
            var loss = elem.Reduce(ReduceKind.Sum, keepDims: false).Scalar();
