namespace Shorokoo.Tests.Modules
{
    ...
    internal static class RecurrentReverseHelpers
    {
        public static Scalar<float32> RnnRevLoss(Variable x)
        {
            var (y, yh) = OnnxOp.Rnn(x,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.RnnWConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.RnnRConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.RnnBConst())!, null, null,
            ...
            return ((Tensor<float32>)(Variable)y).Reduce(ReduceKind.Sum, keepDims: false).Scalar()
                 + ((Tensor<float32>)(Variable)yh).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        }

        public static Scalar<float32> GruRevLoss(Variable x)
        {
            var (y, yh) = OnnxOp.Gru(x,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.GruWConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.GruRConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.GruBConst())!, null, null,
        ...
        public static Scalar<float32> LstmRevLoss(Variable x)
        {
            var (y, yh, yc) = OnnxOp.Lstm(x,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.LstmWConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.LstmRConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.LstmBConst())!, null, null, null, null,
                null, null, null, null, LSTMDirection.Reverse, 2L, null, false);
            return ((Tensor<float32>)(Variable)y).Reduce(ReduceKind.Sum, keepDims: false).Scalar()
                 + ((Tensor<float32>)(Variable)yh).Reduce(ReduceKind.Sum, keepDims: false).Scalar()
                 + ((Tensor<float32>)(Variable)yc).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
        }
    }
    ...
    public partial class AutoGradRnnBidirectionalThrowCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> xv)
        {
            var w = (Tensor<float32>)(Variable)OnnxOp.Concat(
                [Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.RnnWConst())!,
                 Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.RnnWConst())!], axis: 0);
            var r = (Tensor<float32>)(Variable)OnnxOp.Concat(
                [Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.RnnRConst())!,
                 Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.RnnRConst())!], axis: 0);
    ...
    public partial class AutoGradGruClipThrowCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> xv)
        {
            var (_, yh) = OnnxOp.Gru(RecurrentTestData.BuildX(xv, 2),
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.GruWConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.GruRConst())!, null, null, null,
    ...
    public partial class AutoGradLstmPeepholeThrowCheck
    {
        public static Scalar<bit> Inline(Scalar<float32> xv)
        {
            ...
            var (_, yh, _) = OnnxOp.Lstm(RecurrentTestData.BuildX(xv, 2),
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.LstmWConst())!,
                Shorokoo.Core.VariableHandle.Normalize(RecurrentTestData.LstmRConst())!, null, null,
    ...
    public partial class AutoGradDeformConvThrowCheck
    {
        ...
        {
            var x = (Tensor<float32>)(Variable)OnnxOp.Expand(a, Vector(1L, 1L, 4L, 4L));
            var w = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0.5f), Vector(1L, 1L, 2L, 2L));
            var offset = (Tensor<float32>)(Variable)OnnxOp.Expand(Scalar(0.25f), Vector(1L, 8L, 3L, 3L));
            var conved = (Tensor<float32>)(Variable)OnnxOp.DeformConv(x, w, offset, null, null,
    ...
    public partial class AutoGradDftOnesidedCheck
    {
        ...
        {
            var grad = (Tensor<float32>)(Variable)Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, DftLoss(x));
        ...
        {
            var dft = (Tensor<float32>)(Variable)OnnxOp.Dft(x, null, Scalar(1L), inverse: false, onesided: true);
            var w = (Tensor<float32>)(Variable)OnnxOp.Reshape(
    ...
    public partial class AutoGradDftInverseCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var grad = (Tensor<float32>)(Variable)Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, IdftLoss(x));
        ...
        {
            var idft = (Tensor<float32>)(Variable)OnnxOp.Dft(x, null, Scalar(1L), inverse: true, onesided: false);
            var w = (Tensor<float32>)(Variable)OnnxOp.Reshape(
    ...
    public partial class AutoGradStftSignalCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var grad = (Tensor<float32>)(Variable)Shorokoo.Core.Nodes.AutoDiff.Ops.AutoGrad(x, StftLoss(x));
        ...
        private static Scalar<float32> StftLoss(Tensor<float32> x)
        {
            ...
            var stft = (Tensor<float32>)(Variable)OnnxOp.STFT(x, Scalar(2L), window, null);  // [1,3,3,2]
            var w = (Tensor<float32>)(Variable)OnnxOp.Reshape(
    ...
    public partial class AutoGradStftWindowCheck
    {
        ...
        private static Scalar<float32> StftWindowLoss(Scalar<float32> wv)
        {
            ...
            var window = (Tensor<float32>)(Variable)OnnxOp.Concat([wVec, Vector(1.0f, 0.75f, 0.25f)], axis: 0);
            var x = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                OnnxOp.Cast(OnnxOp.Range(Scalar(1L), Scalar(9L), Scalar(1L)), saturate: null, to: DType.Float32),
    ...
    public partial class AutoGradStftNoWindowCheck
    {
        ...
        private static Scalar<float32> StftLoss(Tensor<float32> x)
        {
            var stft = (Tensor<float32>)(Variable)OnnxOp.STFT(x, Scalar(3L), null, Scalar(4L));  // [1,3,3,2]
            var w = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                OnnxOp.Cast(OnnxOp.Range(Scalar(1L), Scalar(19L), Scalar(1L)), saturate: null, to: DType.Float32),
                Vector(1L, 3L, 3L, 2L), allowZero: false);
            return (stft * w).Reduce(ReduceKind.Sum, keepDims: false).Scalar();
    ...
    public partial class AutoGradAffineGrid3DCheck
    {
        ...
        {
            var thetaBase = (Tensor<float32>)(Variable)OnnxOp.Reshape(
            ...
            var size = (Tensor<int64>)(Variable)OnnxOp.Constant(TensorData(5, 1L, 1L, 2L, 2L, 2L));
            var grid = (Tensor<float32>)(Variable)OnnxOp.AffineGrid(theta, size, alignCorners: false); // [1,2,2,2,3]
            var w = (Tensor<float32>)(Variable)OnnxOp.Reshape(
    ...
    public partial class AutoGradBatchNormTrainingInputCheck
    {
        ...
        {
            var c = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                OnnxOp.Cast(OnnxOp.Range(Scalar(1L), Scalar(9L), Scalar(1L)), saturate: null, to: DType.Float32),
            ...
            var y = (Tensor<float32>)(Variable)OnnxOp.BatchNormalization(x, scale, bias, mean, variance,
    ...
    public partial class AutoGradBatchNormTrainingScaleBiasCheck
    {
        ...
        {
            var grid = (Tensor<float32>)(Variable)OnnxOp.Reshape(
                OnnxOp.Cast(OnnxOp.Range(Scalar(1L), Scalar(9L), Scalar(1L)), saturate: null, to: DType.Float32),
                Vector(1L, 2L, 2L, 2L), allowZero: false);
            var scale = (Tensor<float32>)(Variable)OnnxOp.Expand(s, Vector(2L));
            var bias = (Tensor<float32>)(Variable)OnnxOp.Expand(t, Vector(2L));
            var mean = Vector(0.0f, 0.0f).Tensor();
            var variance = Vector(1.0f, 1.0f).Tensor();
            var y = (Tensor<float32>)(Variable)OnnxOp.BatchNormalization(grid, scale, bias, mean, variance,
                epsilon: 1e-5f, momentum: null, trainingMode: true);
            ...
            var batchMean = (Tensor<float32>)(Variable)OnnxOp.ReduceMean(grid, axes, keepdims: true, noopWithEmptyAxes: null);
            var xc = grid - batchMean;
            var batchVar = (Tensor<float32>)(Variable)OnnxOp.ReduceMean(xc * xc, axes, keepdims: true, noopWithEmptyAxes: null);
