namespace Shorokoo.Tests.Modules
{
    ...
    public partial class AutoGradEngineSliceStepsCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var sliced = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Slice(x,
    ...
    public partial class AutoGradEnginePadReflectThrowCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            var padded = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Pad(x, Vector(1L, 1L), mode: PadMode.Reflect);
    ...
    public partial class AutoGradEngineScatterMulThrowCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var updates = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.Expand(Scalar(2f), Vector(1L));
            var scattered = (Tensor<float32>)(ImmutableTensor<float32>)OnnxOp.ScatterND(x, indices, updates, ScatterNDReduction.Mul);
