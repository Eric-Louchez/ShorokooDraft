namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeNormalizationAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var instNorm = (Tensor<float32>)(Variable)OnnxOp.InstanceNormalization(
            ...
            var lrn = (Tensor<float32>)(Variable)OnnxOp.Lrn(xg, alpha: 1e-4f, beta: 0.75f, bias: 1f, size: 3L);
            var lpNorm = (Tensor<float32>)(Variable)OnnxOp.LpNormalization(x, axis: 0, p: 1);
    ...
    public partial class QeeLossDropoutAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> scores, Tensor<int64> labels)
        {
            ...
            var mismatch =
                ...
                FloatMismatch(Flat((Tensor<float32>)(Variable)drop1), flatScores) +
                IntMismatch(FlatI(((Tensor<bit>)(Variable)mask1!).Cast<int64>()), Vector(1L, 1L, 1L, 1L, 1L, 1L)) +
                ShapeMismatch((Tensor<bit>)(Variable)mask1!, Vector(2L, 3L)) +
                FloatMismatch(Flat((Tensor<float32>)(Variable)drop2), flatScores) +
                IntMismatch(FlatI(((Tensor<bit>)(Variable)mask2!).Cast<int64>()), Vector(1L, 1L, 1L, 1L, 1L, 1L));
            return mismatch < Scalar(1L);
        }
    ...
    public partial class QeeMatMulGemmValueAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> g)
        {
            ...
            var mm = g.MatMul(m32);
            var mv = (Tensor<float32>)(Variable)OnnxOp.MatMul(v3, m32);   // [K]×[K,N] → [N]
            var vm = (Tensor<float32>)(Variable)OnnxOp.MatMul(g, v3);     // [M,K]×[K] → [M]
            var vv = (Tensor<float32>)(Variable)OnnxOp.MatMul(v3, v3);    // [K]×[K] → scalar
            var bm = (Tensor<float32>)(Variable)OnnxOp.MatMul(b3, m32);   // batched broadcast

            var gemmC = (Tensor<float32>)(Variable)OnnxOp.Gemm(g, m32, Vector(1f, 2f));
            var gemmTB = (Tensor<float32>)(Variable)OnnxOp.Gemm(g, bT, null, transB: 1);
            var gemmTA = (Tensor<float32>)(Variable)OnnxOp.Gemm(aT, m32, null, transA: 1);
            var gemmAB = (Tensor<float32>)(Variable)OnnxOp.Gemm(g, m32, Scalar(1f), alpha: 0.5f, beta: 2f);
            ...
            var mmi = (Tensor<int32>)(Variable)OnnxOp.MatMulInteger(aq, bq, Scalar((sbyte)1), Scalar((sbyte)2));
            var mmiNoZp = (Tensor<int32>)(Variable)OnnxOp.MatMulInteger(aq, bq);
            var mmiVec = (Tensor<int32>)(Variable)OnnxOp.MatMulInteger(Vector((sbyte)1, (sbyte)2), bq);
            ...
            var qlmm = (Tensor<int8>)(Variable)OnnxOp.QLinearMatMul(
    ...
    public partial class QeeEinsumDetAuditCheck
    {
        public static Scalar<bit> Inline(Tensor<float32> x)
        {
            ...
            var eMatMul = (Tensor<float32>)(Variable)OnnxOp.Einsum(new IValue[] { x, k34 }, "ij,jk->ik");
            var eTrans = (Tensor<float32>)(Variable)OnnxOp.Einsum(new IValue[] { x }, "ij->ji");
            var eReduce = (Tensor<float32>)(Variable)OnnxOp.Einsum(new IValue[] { x }, "ij->i");
            var eDiag = (Tensor<float32>)(Variable)OnnxOp.Einsum(new IValue[] { sq33 }, "ii->i");
            var eImplicit = (Tensor<float32>)(Variable)OnnxOp.Einsum(new IValue[] { x, k34 }, "ij,jk");
            var eBatch = (Tensor<float32>)(Variable)OnnxOp.Einsum(new IValue[] { b223, b232 }, "bij,bjk->bik");
    ...
    public partial class QeeQuantizationValueAuditCheck
    {
        ...
        {
            var qt = (Tensor<int8>)(Variable)OnnxOp.QuantizeLinear(q, Scalar(0.5f), Scalar((sbyte)1));
            var qa = (Tensor<int8>)(Variable)OnnxOp.QuantizeLinear(q,
                Vector(0.5f, 0.25f).Tensor(), Vector((sbyte)0, (sbyte)10), axis: 0);
            var qs = (Tensor<int8>)(Variable)OnnxOp.QuantizeLinear(
