namespace Shorokoo.Tests.Modules
{
    ...
    public partial class QeeSpaceDepthOpsCheck
    {
        ...
        {
            var sd = (Tensor<float32>)(ImmutableTensor)OnnxOp.SpaceToDepth(x, blockSize: 2);
            var ds = (Tensor<float32>)(ImmutableTensor)OnnxOp.DepthToSpace(sd, blockSize: 2, mode: DepthColumnRowMode.DCR);
            return (sd, ds);
        }
    }
    ...
    public partial class QeeCenterCropPadOpsCheck
    {
        public static (Tensor<float32>, Tensor<float32>) Inline(Tensor<float32> x)
        {
            ...
            var allAxes = (Tensor<float32>)(ImmutableTensor)OnnxOp.CenterCropPad(x, Vector(2L, 2L), axes: null);
            // With axes → only the listed dim resizes.
            var oneAxis = (Tensor<float32>)(ImmutableTensor)OnnxOp.CenterCropPad(x, Vector(2L), axes: new long[] { 1L });
    ...
    public partial class QeeAffineGridSampleOpsCheck
    {
        ...
        {
            var grid = (Tensor<float32>)(ImmutableTensor)OnnxOp.AffineGrid(theta, Vector(1L, 1L, 2L, 2L), alignCorners: false);
            var sampled = (Tensor<float32>)(ImmutableTensor)OnnxOp.GridSample(x, grid,
    ...
    public partial class QeeMaxUnpoolOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<float32> pooled, Tensor<int64> indices)
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.MaxUnpool(pooled, indices,
    ...
    public partial class QeePoolingVariantsOpsCheck
    {
        ...
        {
            var lrn = (Tensor<float32>)(ImmutableTensor)OnnxOp.Lrn(x, alpha: 1e-4f, beta: 0.75f, bias: 1f, size: 3L);
            var lp = (Tensor<float32>)(ImmutableTensor)OnnxOp.LpPool(x,
            ...
            var glp = (Tensor<float32>)(ImmutableTensor)OnnxOp.GlobalLpPool(x, p: 2L);
            return (lrn, lp, glp);
        }
    }
    ...
    public partial class QeeBernoulliOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<float32> x)
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.Bernoulli(x, dtype: null, seed: 1f);
    }
    ...
    public partial class QeeBitShiftOpsCheck
    {
        ...
        {
            var shiftL = (Tensor<uint64>)(ImmutableTensor)OnnxOp.BitShift(a, b, direction: BitShiftDirection.Left);
            var shiftR = (Tensor<uint64>)(ImmutableTensor)OnnxOp.BitShift(a, b, direction: BitShiftDirection.Right);
    ...
    public partial class QeeCompressOpsCheck
    {
        ...
        {
            var alongAxis = (Tensor<float32>)(ImmutableTensor)OnnxOp.Compress(x, cond, axis: 0);
            var flattened = (Tensor<float32>)(ImmutableTensor)OnnxOp.Compress(x, cond, axis: null);
    ...
    public partial class QeeReverseSequenceOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<float32> x, Tensor<int64> seqLens)
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.ReverseSequence(x, seqLens, batchAxis: 0, timeAxis: 1);
    }
    ...
    public partial class QeeCumSumVariantsOpsCheck
    {
        public static (Tensor<float32>, Tensor<float32>, Tensor<float32>) Inline(Tensor<float32> x)
        {
            var c1 = (Tensor<float32>)(ImmutableTensor)OnnxOp.CumSum(x, Scalar(0L), exclusive: false, reverse: false);
            var c2 = (Tensor<float32>)(ImmutableTensor)OnnxOp.CumSum(x, Scalar(0L), exclusive: true, reverse: false);
            var c3 = (Tensor<float32>)(ImmutableTensor)OnnxOp.CumSum(x, Scalar(0L), exclusive: false, reverse: true);
            return (c1, c2, c3);
        }
    }
    ...
    public partial class QeeDetEinsumOpsCheck
    {
        ...
        {
            var det = (Tensor<float32>)(ImmutableTensor)OnnxOp.Det(mat);
            // Einsum with explicit output: "ij,ji->" computes the trace of A·B.
            var trace = (Tensor<float32>)(ImmutableTensor)OnnxOp.Einsum(new IValue[] { mat, mat }, equation: "ij,ji->");
            return (det, trace);
        }
    }
    ...
    public partial class QeeEinsumImplicitOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<float32> a, Tensor<float32> b)
            ...
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.Einsum(new IValue[] { a, b }, equation: "ij,jk");
    }
    ...
    public partial class QeeUniqueOpsCheck
    {
        public static (Tensor<float32>, Tensor<int64>, Tensor<int64>, Tensor<int64>) Inline(Tensor<float32> x)
        {
            ...
            return ((Tensor<float32>)(ImmutableTensor)y, (Tensor<int64>)(ImmutableTensor)idx, (Tensor<int64>)(ImmutableTensor)inv, (Tensor<int64>)(ImmutableTensor)counts);
        }
    }
    ...
    public partial class QeeUniqueFlatOpsCheck
    {
        public static (Tensor<float32>, Tensor<int64>) Inline(Tensor<float32> x)
        {
            ...
            return ((Tensor<float32>)(ImmutableTensor)y, (Tensor<int64>)(ImmutableTensor)idx);
        }
    }
    ...
    {
        public static Tensor<float32> Inline(Tensor<float32> x)
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.Upsample(x, Vector(1f, 1f, 2f, 2f), mode: ResizeMode.Nearest);
    }
    ...
    public partial class QeeCol2ImOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<float32> cols)
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.Col2Im(cols,
    ...
    public partial class QeeDeformConvOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<float32> x, Tensor<float32> w, Tensor<float32> offset, Vector<float32> b)
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.DeformConv(x, w, offset, b, mask: null,
    ...
    public partial class QeeConvIntegerOpsCheck
    {
        public static Tensor<int32> Inline(Tensor<int8> x, Tensor<int8> w, Scalar<int8> xZp, Scalar<int8> wZp)
            => (Tensor<int32>)(ImmutableTensor)OnnxOp.ConvInteger(x, w, xZp, wZp,
    ...
    public partial class QeeMatMulIntegerOpsCheck
    {
        public static Tensor<int32> Inline(Tensor<int8> a, Tensor<int8> b, Scalar<int8> aZp, Scalar<int8> bZp)
            => (Tensor<int32>)(ImmutableTensor)OnnxOp.MatMulInteger(a, b, aZp, bZp);
    }
    ...
    public partial class QeeDequantizeLinearOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<int8> x, Tensor<float32> scale, Tensor<int8> zp)
            => (Tensor<float32>)(ImmutableTensor)OnnxOp.DequantizeLinear(x, scale, zp, axis: 1, blockSize: null);
    }
    ...
    public partial class QeeDynamicQuantizeLinearOpsCheck
    {
        public static (Scalar<uint8>, Scalar<float32>, Scalar<uint8>) Inline(Scalar<float32> x)
        {
            ...
            return ((Scalar<uint8>)(ImmutableScalar)y, (Scalar<float32>)(ImmutableScalar)scale, (Scalar<uint8>)(ImmutableScalar)zp);
        }
    }
    ...
    public partial class QeeShrkConvOpsCheck
    {
        public static Tensor<float32> Inline(Tensor<float32> x, Tensor<float32> w, Vector<float32> b)
            => (Tensor<float32>)(ImmutableTensor)InternalOp.Conv(x, w, b, AutoPad.NotSet,
