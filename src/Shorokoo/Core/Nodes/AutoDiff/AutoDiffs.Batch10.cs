...
namespace Shorokoo.Core.Nodes.AutoDiff
{
    internal static partial class AutoDiffs
    {
        ...
        private static void GuardRecurrentAttributeEnvelope(
            ...
            IValue? sequenceLens, string[] defaultActivations)
        {
        ...
        /// </summary>
        private static IValue ReverseTimeAxis(IValue t)
        {
        ...
        internal static IValue?[] RnnGradient(IValue?[] inputs, IValue?[] outputGrads, OnnxCSharpAttributes attributes)
        {
            ...
            IValue? dBacc = b is not null ? OnnxOp.Sub(bSq!, bSq!) : null;  // [2H] zeros or null
