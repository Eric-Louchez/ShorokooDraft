...
{
    /// <summary>
    /// Fast-side counterparts to the IValue factory helpers in <see cref="InternalOp"/>.
    ...
    internal static class FastInternalOp
    {
        ...
        /// <paramref name="inputKeys"/> (parallel to the inputs, matching the IValue variant
        /// which returns <c>IValue?[]</c> of the same length).
        /// </summary>
