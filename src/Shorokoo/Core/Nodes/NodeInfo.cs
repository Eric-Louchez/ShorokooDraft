...
namespace Shorokoo.Core.Nodes
{
    internal class NodeInfo
    {
        ...
        public NodeInfo(IValue?[] inputs, IValue?[] outputs, OnnxProtoAttributes attributes, string? identifierTemplateString, string? stackTrace, OpSetVersion version, string opCode, string domain = "")
        {
