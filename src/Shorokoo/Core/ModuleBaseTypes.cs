...
namespace Shorokoo.Core
{
    ...
    public abstract class BaseModel<Tout> : IModel
    {
        ...
        public BaseModel(InputType inputType)
        {
            ...
            this.ModelVariable = (ImmutableScalar)InternalOp.ModuleTensorInput(DType.Model, rank: 0, inputType, targetFunction, null);
        }
    ...
    public class CallbackModule<TOutputs> : IModule
    {
        ...
        public CallbackModule(InputType inputType)
        {
            ...
            this.ModuleVariable = (ImmutableScalar)InternalOp.ModuleTensorInput(DType.Module, 0, inputType, targetFunction, null);
        }
        ...
        public T SetHyperparams<T>() where T : BaseModel<TOutputs>
        {
            ...
            Scalar<IModelVarType> modelVariable = (ImmutableScalar)InternalOp.ModuleSetHyperparams(this.ModuleVariable, [], iterationIndices, localModelId: null, identifierTemplateString: null);
    ...
    public class CallbackModule<THyperparams, TOutputs> : IModule
    {
        ...
        public T SetHyperparams<T>(THyperparams hyperparams) where T : BaseModel<TOutputs>
        {
            ...
            Scalar<IModelVarType> modelVariable = (ImmutableScalar)InternalOp.ModuleSetHyperparams(this.ModuleVariable, inputVariables, iterationIndices, localModelId: null, identifierTemplateString: null);
