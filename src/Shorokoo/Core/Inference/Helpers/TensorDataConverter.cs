...
internal static class TensorDataConverter
{
    ...
    /// </summary>
    public static RuntimeTensor ToRuntimeTensor(TensorData data, int maxElements, IValue? reference = null)
    {
    ...
    /// </summary>
    public static RuntimeOptionalTensor ToRuntimeOptional(OptionalTensorData data, int maxElements, IValue? reference = null)
    ...
    /// </summary>
    public static IRuntimeTensor ToRuntimeInput(IData data, int maxElements, IValue? reference = null)
        => data switch
        {
