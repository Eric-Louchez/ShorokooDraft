...
public static class Recurrent
{
        ...
        bool bias = true)
    {
        ...
        for (int layer = 0; layer < numLayers; layer++)
        {
            ...
            var yhLayer = (Tensor<float32>)(ImmutableTensor)yhVar;  // [D, N, H]
        ...
        bool bias = true)
    {
        ...
        for (int layer = 0; layer < numLayers; layer++)
        {
            ...
            var yLayer = (Tensor<float32>)(ImmutableTensor)yVar;    // [L, D, N, H]
            var yhLayer = (Tensor<float32>)(ImmutableTensor)yhVar;  // [D, N, H]
            var ycLayer = (Tensor<float32>)(ImmutableTensor)ycVar;  // [D, N, H]
        ...
        bool bias = true)
    {
        ...
        var hOut = ((Tensor<float32>)(ImmutableTensor)yhVar).Squeeze(Vector(0L));
        var cOut = ((Tensor<float32>)(ImmutableTensor)ycVar).Squeeze(Vector(0L));
        return (hOut, cOut);
    }
