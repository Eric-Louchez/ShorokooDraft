...
public static class Pooling
{
        ...
        where T : FloatLike
    {
        ...
        return (Tensor<T>)(ImmutableTensor)OnnxOp.AveragePool(x, autoPad,
            ceilMode ? true : null,
    ...
    {
        long s = stride ?? kernelSize;
        return (Tensor<T>)(ImmutableTensor)OnnxOp.AveragePool(x, AutoPad.NotSet,
            ceilMode ? true : null,
            countIncludePad ? true : null,
            dilations: null,
            kernelShape: [kernelSize, kernelSize],
        ...
        where T : FloatLike
    {
        ...
        return (Tensor<T>)(ImmutableTensor)OnnxOp.LpPool(x, autoPad,
            ceilMode ? true : null,
            dilations: dilations,
            kernelShape: kernelSize,
            p: p,
        ...
        where T : FloatLike
    {
        ...
        return (Tensor<T>)(ImmutableTensor)OnnxOp.MaxUnpool(values, indices,
            kernelShape: kernelSize,
            pads: pads,
            strides: strides,
