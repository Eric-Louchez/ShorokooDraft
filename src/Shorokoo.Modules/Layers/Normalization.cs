...
public partial class BatchNorm
{
        ...
        [Hyper] Scalar<bit> trackRunningStats)             // true = eval uses running stats; false = eval uses batch stats
    {
        ...
        reduceAxes = reduceAxes.Concat(((Tensor<int64>)(Variable)OnnxOp.Range(Scalar(2L), rank, one)).Vec());
...
public partial class LayerNorm
{
        ...
        [Hyper] Scalar<float32> epsilon)
    {
        ...
        var axes = ((Tensor<int64>)(Variable)OnnxOp.Range(start, rank, Scalar(1L))).Vec();
...
public partial class InstanceNorm
{
        ...
        [Hyper] Scalar<float32> epsilon)
    {
        ...
        var spatialAxes = ((Tensor<int64>)(Variable)OnnxOp.Range(Scalar(2L), rank, Scalar(1L))).Vec();
